...
public class DlgTemplateResep extends javax.swing.JDialog {
    ...
    public DlgTemplateResep(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"No.Resep","Tgl.Resep","Jam Resep","Aturan Pakai","Kode Obat","Nama Obat","Dokter Peresep","Kode Dokter","Nama Template"};
    ...
    private void initComponents() {
        ...
        BtnTambah.setText("PILIH TEMPLATE");
        BtnTambah.setToolTipText("Alt+S");
        BtnTambah.setName("BtnTambah"); // NOI18N
        BtnTambah.setPreferredSize(new java.awt.Dimension(140, 30));
    ...
    private void BtnKeluarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnKeluarKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){            
            dispose();              
        }else{Valid.pindah(evt,TCari,BtnTambah);}
 ...
 // tampil2();
    ...
    */
    ...
    public void tampil() {
        ...
        try{  
                ps=koneksi.prepareStatement("select resep_obat_template.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,"+
                    ...
                    " resep_obat_template.nama_template from resep_obat inner join reg_periksa inner join pasien inner join dokter inner join resep_obat_template on resep_obat.no_rawat=reg_periksa.no_rawat  "+
                    " and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and resep_obat.kd_dokter=dokter.kd_dokter and resep_obat_template.no_resep=resep_obat.no_resep where "+
                ...
                /*ps=koneksi.prepareStatement("select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,"+
                    " resep_obat.no_rawat,resep_obat_template.nama_template,resep_obat.kd_dokter,dokter.nm_dokter, "+
                    " if(resep_obat.tgl_perawatan='0000-00-00','Belum Terlayani','Sudah Terlayani') as status,resep_obat.status as status_asal "+
                    " from resep_obat inner join reg_periksa inner join dokter inner join resep_obat_template on resep_obat.no_rawat=reg_periksa.no_rawat  "+
                    " and resep_obat.kd_dokter=dokter.kd_dokter and resep_obat.no_resep=resep_obat_template.no_resep where "+
                    " resep_obat.kd_dokter=? and resep_obat_template.nama_template like ? order by resep_obat.tgl_perawatan,resep_obat.jam ASC LIMIT " + cmbHlm.getSelectedItem().toString() + "");*/ 
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        "","",rs.getString("nm_dokter"),rs.getString("kd_dokter"),rs.getString("nama_template")
                    });  
    ...
    private void panggilform() {
        ...
        resep.setNoRmTemplate(norawat,tbPemisahan.getValueAt(tbPemisahan.getSelectedRow(),7).toString(),
