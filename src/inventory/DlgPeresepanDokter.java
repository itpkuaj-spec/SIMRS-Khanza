...
public final class DlgPeresepanDokter extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-11-2025" }));
...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    ...
    */
    ...
    private void hitungResep() {
        ...
        // Logic untuk mengubah warna
if (ttl > 50000) {
    LTotal.setForeground(java.awt.Color.RED);
} else {
    // Kembalikan ke warna hitam atau warna default jika di bawah 50.000
    LTotal.setForeground(new java.awt.Color(40, 40, 40)); 
}
        ppnobat=0;
