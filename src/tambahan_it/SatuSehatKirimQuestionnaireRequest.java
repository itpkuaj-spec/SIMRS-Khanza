...
//                    + "	reg_periksa.tgl_registrasi ASC, reg_periksa.jam_reg ASC, reg_periksa.no_rawat ASC");
    ...
    "    telaah_farmasi.resep_ket_identifikasi_pasien, " +
    "    telaah_farmasi.resep_ket_tepat_obat, " +
    "    telaah_farmasi.resep_tepat_dosis, " +
    "    telaah_farmasi.resep_ket_tepat_dosis, " +
    "    telaah_farmasi.resep_tepat_cara_pemberian, " +
    "    telaah_farmasi.resep_ket_tepat_cara_pemberian, " +
    "    telaah_farmasi.resep_tepat_waktu_pemberian, " +
    "    telaah_farmasi.resep_ket_tepat_waktu_pemberian, " +
    "    telaah_farmasi.resep_ada_tidak_duplikasi_obat, " +
    "    telaah_farmasi.resep_ket_ada_tidak_duplikasi_obat, " +
    "    telaah_farmasi.resep_interaksi_obat, " +
    "    telaah_farmasi.resep_ket_interaksi_obat, " +
    "    telaah_farmasi.resep_kontra_indikasi_obat, " +
    "    telaah_farmasi.resep_ket_kontra_indikasi_obat, " +
    ...
    "    IFNULL(satu_sehat_questionnairereq_pengkajian_obat.id_questreq, '') AS id_questreq " +
    "FROM telaah_farmasi " +
    "LEFT JOIN satu_sehat_questionnairereq_pengkajian_obat " +
    "   ON telaah_farmasi.no_resep = satu_sehat_questionnairereq_pengkajian_obat.no_resep " +
    "INNER JOIN pegawai ON telaah_farmasi.nip = pegawai.nik " +
    "WHERE " + belumterkirim + " telaah_farmasi.no_resep BETWEEN ? AND ? " +
    (TCari.getText().trim().equals("") ? "" :
    "AND (telaah_farmasi.no_resep LIKE ? OR " +
    "     pegawai.nama LIKE ? OR " +
    "     pegawai.no_ktp LIKE ?) ") +
    "GROUP BY telaah_farmasi.no_resep " +
    "ORDER BY telaah_farmasi.no_resep ASC");
                    ...
                    //if (cekflagging.GeneralConsentSatuSehat(rs.getString("no_rkm_medis")) == true) {
                        if (rs.getString("id_questreq").equals("")) {
                            tabMode.addRow(new Object[]{
                                true,
                                rs.getString("tgl_penyerahan") + "T" + rs.getString("jam") + "+07:00",
