...
public class DlgSBARRNP extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgSBARRNP(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         setSize(1285,674);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgSBARRNP dialog = new DlgSBARRNP(new javax.swing.JFrame(), true);
