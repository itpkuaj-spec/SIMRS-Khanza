...
public class BPJSSuratKontrol extends javax.swing.JDialog {
    ...
    private Connection koneksiwa;//tambahan wa
    private sekuel Sequel=new sekuel();
    private validasi Valid=new validasi();
    private PreparedStatement ps,psWa;//tambahan wa
    ...
    private String link="",requestJson="",URL="",user="",URUTNOREG="",utc="",JADIKANBOOKINGSURATKONTROLAPIBPJS="no",kodedokter="",kodepoli="",noreg="",notifwapasien = "", pesan = "", tanggaljamkirim = "";//tambahan wa
