    ...
    */
    ...
    private void ganti() {
        if(Sequel.mengedittf("monitoring_reaksi_tranfusi","tgl_perawatan=? and jam_rawat=? and no_rawat=?","no_rawat=?,tgl_perawatan=?,jam_rawat=?,produk_darah=?,"+
            ...
            Keterangan.getText(),KdPetugas.getText(),Tgolongandarah.getText(),Tkadaluarsa.getText(),Tjmlhdarah.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),6).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),7).toString(),//tambahan 3 kolom
    ...
    private void simpan() {
        if(Sequel.menyimpantf("monitoring_reaksi_tranfusi","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",16,new String[]{//tambahan default 13
            TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
            JenisDarah.getText(),NoKantong.getText(),LokasiInsersi.getText(),TD.getText(),HR.getText(),RR.getText(),Suhu.getText(),Alergi.getText(), 
            Keterangan.getText(),KdPetugas.getText(),Tgolongandarah.getText(),Tkadaluarsa.getText(),Tjmlhdarah.getText()//tambahan
        })==true){
            tabMode.addRow(new Object[]{
                ...
                JenisDarah.getText(),NoKantong.getText(),LokasiInsersi.getText(),TD.getText(),HR.getText(),RR.getText(),Suhu.getText(),Alergi.getText(), 
                Keterangan.getText(),KdPetugas.getText(),NmPetugas.getText(),Tgolongandarah.getText(),Tkadaluarsa.getText(),Tjmlhdarah.getText()//tambahan
            });
            LCount.setText(""+tabMode.getRowCount());
            emptTeks();
        }
