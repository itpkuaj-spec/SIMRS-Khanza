 ...
 * @author dosen
 */
public final class RMCariSdanO extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMCariSdanO(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(656,250);

        Object[] row={"Tanggal","Jam","Subjek","Objek"};
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCariSdanO dialog = new RMCariSdanO(new javax.swing.JFrame(), true);
