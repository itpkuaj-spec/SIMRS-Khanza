 ...
 * @author dosen
 */
public final class RMCariodanttv extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMCariodanttv(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(656,250);

        Object[] row={"Tanggal","Jam","Pemeriksaan","Suhu","Tensi","Nadi","Resp","TB","BB","SPO2","gcs"};
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCariodanttv dialog = new RMCariodanttv(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat,pemeriksaan_ranap.pemeriksaan,pemeriksaan_ranap.suhu_tubuh,pemeriksaan_ranap.tensi,pemeriksaan_ranap.nadi,pemeriksaan_ranap.respirasi,pemeriksaan_ranap.tinggi,pemeriksaan_ranap.berat,spo2,pemeriksaan_ranap.gcs "+
