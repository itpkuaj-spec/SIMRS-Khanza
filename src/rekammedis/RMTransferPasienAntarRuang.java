...
public final class RMTransferPasienAntarRuang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ppCetakLembarTransfer = new javax.swing.JMenuItem();
        ...
        ppCetakLembarTransfer.setBackground(new java.awt.Color(255, 255, 254));
        ppCetakLembarTransfer.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppCetakLembarTransfer.setForeground(new java.awt.Color(50, 50, 50));
        ppCetakLembarTransfer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        ppCetakLembarTransfer.setText("Cetak Lembar Transfer Pasien");
        ppCetakLembarTransfer.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppCetakLembarTransfer.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppCetakLembarTransfer.setName("ppCetakLembarTransfer"); // NOI18N
        ppCetakLembarTransfer.setPreferredSize(new java.awt.Dimension(250, 25));
        ppCetakLembarTransfer.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppCetakLembarTransferActionPerformed(evt);
            }
        });
        Popup.add(ppCetakLembarTransfer);
        ...
        TanggalMasuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "27-08-2026 10:03:51" }));
        ...
        TanggalPindah.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "27-08-2026 10:03:51" }));
...
//tambahan it
    private void ppCetakLembarTransferActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppCetakLembarTransferActionPerformed
        if(tbObat.getSelectedRow()!= -1){
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            ...
            String finger=Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",tbObat.getValueAt(tbObat.getSelectedRow(),34).toString());
            ...
            String finger2=Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",tbObat.getValueAt(tbObat.getSelectedRow(),36).toString());
            ...
            Valid.MyReportqry("rptTransferPasienAntarRuang.jasper","report","::[ Lembar Transfer Pasien Antar Ruang ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,"+
                "transfer_pasien_antar_ruang.tanggal_masuk,transfer_pasien_antar_ruang.tanggal_pindah,transfer_pasien_antar_ruang.asal_ruang,"+
                "transfer_pasien_antar_ruang.ruang_selanjutnya,transfer_pasien_antar_ruang.diagnosa_utama,transfer_pasien_antar_ruang.diagnosa_sekunder,"+
                "transfer_pasien_antar_ruang.indikasi_pindah_ruang,transfer_pasien_antar_ruang.keterangan_indikasi_pindah_ruang,"+
                ...
                "and transfer_pasien_antar_ruang.tanggal_pindah='"+tbObat.getValueAt(tbObat.getSelectedRow(),6).toString()+"' ",param);
            this.setCursor(Cursor.getDefaultCursor());
        }else{
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan pilih data yang mau dicetak terlebih dahulu...!!!!");
        }
    }//GEN-LAST:event_ppCetakLembarTransferActionPerformed
//sampe sini
    /**
    ...
    */
    ...
    private javax.swing.JMenuItem ppCetakLembarTransfer;
