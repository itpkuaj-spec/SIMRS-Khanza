...
public final class DlgDetailKlaimrajal extends javax.swing.JDialog {
    ...
    public DlgDetailKlaimrajal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
 ...
 Sequel.queryu("delete from tb_inacbg_prosedure where no_rawat='" + norawat + "' and kode='" + tbProsedureINACBG.getValueAt(tbProsedureINACBG.getSelectedRow(), 0).toString() + "'  ");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgDetailKlaimrajal dialog = new DlgDetailKlaimrajal(new javax.swing.JFrame(), true);
