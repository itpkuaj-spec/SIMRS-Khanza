...
public final class DlgDetailKlaim3 extends javax.swing.JDialog {
    private String nikCoder = ""; //tambahan
    ...
    public DlgDetailKlaim3(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//                }
        ...
        tabModeProsedurePasien = new DefaultTableModel(null, new Object[]{
            "Kode", "Nama Penyakit", "Status", "Jumlah"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                boolean a = false;
//                if (colIndex == 0) {
...
//                }
        ...
        for (i = 0; i < 3; i++) {
            ...
            if (i == 0) {
                ...
                column.setPreferredWidth(80);   // Jumlah
            }
        }
...
//        });
    ...
    private void initComponents() {
        ...
        btnDiagnosaLocal = new widget.Button();
        ...
        btnHasilFinalKlaim = new widget.Button();
        internalFrame7 = new widget.InternalFrame();
        internalFrameDataPasien1 = new widget.InternalFrame();
        internalFrameD1ataPasien1 = new widget.InternalFrame();
        FormInput2 = new widget.PanelBiasa();
        jLabel117 = new widget.Label();
        txtNoRawat1 = new widget.TextBox();
        txtNoRm1 = new widget.TextBox();
        txtNamaPasien1 = new widget.TextBox();
        noKartuJkn1 = new widget.TextBox();
        ...
        FormDataPelayanan1 = new widget.PanelBiasa();
        jLabel122 = new widget.Label();
        txtHakKelas1 = new widget.TextBox();
        jnsLayanan1 = new widget.TextBox();
        jLabel123 = new widget.Label();
        txtNoSep1 = new widget.TextBox();
        jLabel124 = new widget.Label();
        nmPoli1 = new widget.TextBox();
        kdPoli1 = new widget.TextBox();
        jamMasuk1 = new widget.TextBox();
        jLabel125 = new widget.Label();
        jLabel126 = new widget.Label();
        tglMasuk1 = new widget.TextBox();
        jLabel127 = new widget.Label();
        tglPulang1 = new widget.TextBox();
        jamPulang1 = new widget.TextBox();
        jLabel128 = new widget.Label();
        kdDokter1 = new widget.TextBox();
        nmDokter1 = new widget.TextBox();
        jLabel129 = new widget.Label();
        sistol1 = new widget.TextBox();
        diastol1 = new widget.TextBox();
        jLabel130 = new widget.Label();
        jLabel131 = new widget.Label();
        ChkPasienTB1 = new widget.CekBox();
        txtIDSITB1 = new widget.TextBox();
        btnValidasiSITB1 = new widget.Button();
        jLabel132 = new widget.Label();
        beratLahir1 = new widget.TextBox();
        jLabel133 = new widget.Label();
        jLabel134 = new widget.Label();
        panelNaikKelas1 = new widget.PanelBiasa();
        ...
        tarifPoliEksekutif3 = new widget.TextBox();
        panelCeklis1 = new widget.PanelBiasa();
        chkEksekutif1 = new widget.CekBox();
        jLabel139 = new widget.Label();
        chkNaikKelas1 = new widget.CekBox();
        jLabel140 = new widget.Label();
        chkIntensif1 = new widget.CekBox();
        jLabel141 = new widget.Label();
        panelTarifPoliEksekutif1 = new widget.PanelBiasa();
        costPoliEksekutif1 = new widget.Label();
        tarifPoliEksekutif1 = new widget.TextBox();
        jLabel142 = new widget.Label();
        jLabel143 = new widget.Label();
        jLabel144 = new widget.Label();
        jLabel145 = new widget.Label();
        subAcute1 = new widget.TextBox();
        jLabel146 = new widget.Label();
        chronic1 = new widget.TextBox();
        panelRawatIntensif1 = new widget.PanelBiasa();
        jLabel147 = new widget.Label();
        chkVentilator1 = new widget.CekBox();
        jLabel148 = new widget.Label();
        tglIntubasi1 = new widget.Tanggal();
        jLabel149 = new widget.Label();
        tglEkstubasi1 = new widget.Tanggal();
        jLabel150 = new widget.Label();
        icuLos1 = new widget.TextBox();
        cmbCaraMasuk1 = new widget.ComboBox();
        cmrCaraPulang1 = new widget.ComboBox();
        FormInput11 = new widget.PanelBiasa();
        jLabel151 = new widget.Label();
        tfTenagaAhli1 = new widget.TextBox();
        tfTotal1 = new widget.TextBox();
        jLabel152 = new widget.Label();
        jLabel153 = new widget.Label();
        tfNonBedah1 = new widget.TextBox();
        jLabel154 = new widget.Label();
        tfRadiologi1 = new widget.TextBox();
        jLabel155 = new widget.Label();
        tfRehabilitasi1 = new widget.TextBox();
        tfObat1 = new widget.TextBox();
        jLabel156 = new widget.Label();
        jLabel157 = new widget.Label();
        tfAlkes1 = new widget.TextBox();
        jLabel158 = new widget.Label();
        tfBedah1 = new widget.TextBox();
        tfKeperawatan1 = new widget.TextBox();
        jLabel159 = new widget.Label();
        jLabel160 = new widget.Label();
        tfLaboratorium1 = new widget.TextBox();
        jLabel161 = new widget.Label();
        tfKonsultasi1 = new widget.TextBox();
        tfPenunjang1 = new widget.TextBox();
        jLabel162 = new widget.Label();
        jLabel163 = new widget.Label();
        tfDarah1 = new widget.TextBox();
        jLabel164 = new widget.Label();
        jLabel165 = new widget.Label();
        jLabel166 = new widget.Label();
        tfBMHP1 = new widget.TextBox();
        tfObatKronis1 = new widget.TextBox();
        tfKamar1 = new widget.TextBox();
        jLabel167 = new widget.Label();
        tfRawatIntensif1 = new widget.TextBox();
        tfObatKemoterapi1 = new widget.TextBox();
        jLabel168 = new widget.Label();
        jLabel169 = new widget.Label();
        tfSewaAlat1 = new widget.TextBox();
        internalFrame41 = new widget.InternalFrame();
        setDataKlaim1 = new widget.Button();
        btnUpdateDataKlaim1 = new widget.Button();
        btnImportDiagnosaDokter1 = new widget.Button();
        btnDiagnosaLocal1 = new widget.Button();
        FrameKoding1 = new widget.InternalFrame();
        FormKodingIDRG1 = new widget.InternalFrame();
        FormInputIDRG1 = new widget.PanelBiasa();
        internalFrame42 = new widget.InternalFrame();
        internalFrame43 = new widget.InternalFrame();
        internalFrame44 = new widget.InternalFrame();
        internalFrame45 = new widget.InternalFrame();
        Scroll21 = new widget.ScrollPane();
        tbDiagnosaIDRG1 = new widget.Table();
        internalFrame46 = new widget.InternalFrame();
        internalFrame47 = new widget.InternalFrame();
        Scroll22 = new widget.ScrollPane();
        tbProsedurIDRG1 = new widget.Table();
        internalFrame48 = new widget.InternalFrame();
        btnGroupingIDRG1 = new widget.Button();
        btnTambahDiagnosaIDRG1 = new widget.Button();
        btnTambahProsedurIDRG1 = new widget.Button();
        FormInputHasilIDRG1 = new widget.PanelBiasa();
        internalFrame49 = new widget.InternalFrame();
        internalFrame50 = new widget.InternalFrame();
        internalFrame51 = new widget.InternalFrame();
        panelHasilIDRG1 = new widget.PanelBiasa();
        jLabel170 = new widget.Label();
        jLabel171 = new widget.Label();
        jLabel172 = new widget.Label();
        jLabel173 = new widget.Label();
        infoHasiliDRG1 = new widget.Label();
        jsnrawatHasiliDRG1 = new widget.Label();
        mdcCodeHasiliDRG1 = new widget.Label();
        mdcHasiliDRG1 = new widget.Label();
        drgHasiliDRG1 = new widget.Label();
        drgCodeHasiliDRG1 = new widget.Label();
        jLabel174 = new widget.Label();
        statusHasiliDRG1 = new widget.Label();
        btnFinalIDRG1 = new widget.Button();
        btnEditIDRG1 = new widget.Button();
        FormKodingINACBG1 = new widget.InternalFrame();
        FormInputINACBG1 = new widget.PanelBiasa();
        internalFrame52 = new widget.InternalFrame();
        internalFrame53 = new widget.InternalFrame();
        internalFrame54 = new widget.InternalFrame();
        Scroll23 = new widget.ScrollPane();
        tbDiagnosaIINACBG1 = new widget.Table();
        internalFrame55 = new widget.InternalFrame();
        internalFrame56 = new widget.InternalFrame();
        Scroll24 = new widget.ScrollPane();
        tbProsedureINACBG1 = new widget.Table();
        internalFrame57 = new widget.InternalFrame();
        btnImportToINACBG1 = new widget.Button();
        btnGroupingINACBG1 = new widget.Button();
        btnTabahDiagnosaINACBG1 = new widget.Button();
        btnTambahProsedurINACBG1 = new widget.Button();
        FormInputHasilINACBG1 = new widget.PanelBiasa();
        internalFrame58 = new widget.InternalFrame();
        internalFrame59 = new widget.InternalFrame();
        internalFrame60 = new widget.InternalFrame();
        panelHasilINACBG2 = new widget.PanelBiasa();
        ...
        btnFinalINACBG1 = new widget.Button();
        btnEditINACBG1 = new widget.Button();
        infoHasilINACBG1 = new widget.Label();
        jnsrawatHasilINACBG1 = new widget.Label();
        groupHasilINACBG1 = new widget.Label();
        groupCodeHasilINACBG3 = new widget.Label();
        groupCostHasilINACBG3 = new widget.Label();
        jLabel186 = new widget.Label();
        jLabel187 = new widget.Label();
        groupCostHasilINACBG4 = new widget.Label();
        groupCodeHasilINACBG4 = new widget.Label();
        subAcuteHasilINACBG1 = new widget.Label();
        chronicHasilINACBG1 = new widget.Label();
        groupCodeHasilINACBG6 = new widget.Label();
        jLabel188 = new widget.Label();
        groupCostHasilINACBG7 = new widget.Label();
        SpecialProcedureHasilCode1 = new widget.Label();
        jLabel189 = new widget.Label();
        SpecialProcedureHasilCost1 = new widget.Label();
        SpecialProsthesisHasilCode1 = new widget.Label();
        jLabel190 = new widget.Label();
        SpecialProsthesisHasilCost1 = new widget.Label();
        groupCodeHasilINACBG8 = new widget.Label();
        jLabel191 = new widget.Label();
        groupCostHasilINACBG8 = new widget.Label();
        statusHasilInacbg1 = new widget.Label();
        jLabel192 = new widget.Label();
        groupCostHasilINACBG9 = new widget.Label();
        CmbSpecialProcedure1 = new widget.ComboBox();
        CmbSpecialProsthesis1 = new widget.ComboBox();
        CmbSpecialInvestigation1 = new widget.ComboBox();
        CmbSpeciaDrugs1 = new widget.ComboBox();
        totalCostHasilKlaim1 = new widget.Label();
        jLabel193 = new widget.Label();
        groupCodeHasilINACBG9 = new widget.Label();
        FormInputStatusKlaim1 = new widget.PanelBiasa();
        internalFrame61 = new widget.InternalFrame();
        internalFrame62 = new widget.InternalFrame();
        internalFrame63 = new widget.InternalFrame();
        panelHasilINACBG3 = new widget.PanelBiasa();
        jLabel194 = new widget.Label();
        jLabel195 = new widget.Label();
        statusKlaim1 = new widget.Label();
        statusDC1 = new widget.Label();
        internalFrameEndKlaim1 = new widget.InternalFrame();
        btnEditKlaim1 = new widget.Button();
        btnFinalKlaim1 = new widget.Button();
        btnKirimOnline1 = new widget.Button();
        btnCetakKlaim1 = new widget.Button();
        btnHasilFinalKlaim1 = new widget.Button();
        ...
        internalFrame1.setWarnaAtas(new java.awt.Color(65, 105, 225));
        internalFrame1.setWarnaBawah(new java.awt.Color(65, 105, 225));
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(440, 115));
        ...
        tglIntubasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-10-2025 14:12:22" }));
        ...
        tglEkstubasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-10-2025 14:12:23" }));
        ...
        tfTenagaAhli.setBounds(110, 80, 270, 23);
        ...
        tfKamar.setBounds(480, 140, 270, 23);

        jLabel51.setText("Rawat Intensif :");
        jLabel51.setName("jLabel51"); // NOI18N
        FormInput1.add(jLabel51);
        jLabel51.setBounds(740, 140, 100, 23);
        ...
        btnImportDiagnosaDokter.setText("Hasil Koding");
        ...
        btnImportDiagnosaDokter.setPreferredSize(new java.awt.Dimension(180, 23));
        ...
        btnDiagnosaLocal.setBackground(new java.awt.Color(255, 204, 153));
        btnDiagnosaLocal.setForeground(new java.awt.Color(0, 0, 0));
        btnDiagnosaLocal.setMnemonic('4');
        btnDiagnosaLocal.setText("Input Diagnosa & Prosedur");
        btnDiagnosaLocal.setToolTipText("Alt+4");
        btnDiagnosaLocal.setName("btnDiagnosaLocal"); // NOI18N
        btnDiagnosaLocal.setOpaque(true);
        btnDiagnosaLocal.setPreferredSize(new java.awt.Dimension(180, 23));
        btnDiagnosaLocal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnDiagnosaLocalActionPerformed(evt);
            }
        });
        internalFrame8.add(btnDiagnosaLocal);
        ...
        FormInputHasilIDRG.setBackground(new java.awt.Color(0, 255, 255));
        ...
        infoHasiliDRG.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        jsnrawatHasiliDRG.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        mdcCodeHasiliDRG.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        mdcHasiliDRG.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        drgHasiliDRG.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        drgCodeHasiliDRG.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        statusHasiliDRG.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        FormInputHasilINACBG.setBackground(new java.awt.Color(0, 255, 255));
        ...
        infoHasilINACBG.setBounds(120, 5, 810, 23);
        ...
        FormInputStatusKlaim.setBackground(new java.awt.Color(0, 255, 255));
        ...
        btnHasilFinalKlaim.setBackground(new java.awt.Color(255, 153, 0));
        btnHasilFinalKlaim.setForeground(new java.awt.Color(0, 0, 0));
        btnHasilFinalKlaim.setMnemonic('S');
        btnHasilFinalKlaim.setText("Hasil Klaim Final");
        btnHasilFinalKlaim.setToolTipText("Alt+S");
        btnHasilFinalKlaim.setName("btnHasilFinalKlaim"); // NOI18N
        btnHasilFinalKlaim.setOpaque(true);
        btnHasilFinalKlaim.setPreferredSize(new java.awt.Dimension(200, 23));
        btnHasilFinalKlaim.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnHasilFinalKlaimActionPerformed(evt);
            }
        });
        btnHasilFinalKlaim.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                btnHasilFinalKlaimKeyPressed(evt);
            }
        });
        internalFrameEndKlaim.add(btnHasilFinalKlaim);
        ...
        internalFrame7.setPreferredSize(new java.awt.Dimension(494, 2500));
        internalFrame7.setLayout(null);

        internalFrameDataPasien1.setName("internalFrameDataPasien1"); // NOI18N
        internalFrameDataPasien1.setPreferredSize(new java.awt.Dimension(492, 574));
        internalFrameDataPasien1.setLayout(new java.awt.BorderLayout());

        internalFrameD1ataPasien1.setName("internalFrameD1ataPasien1"); // NOI18N
        internalFrameD1ataPasien1.setPreferredSize(new java.awt.Dimension(492, 574));
        internalFrameD1ataPasien1.setLayout(new java.awt.BorderLayout());

        FormInput2.setBorder(javax.swing.BorderFactory.createTitledBorder("Data Pasien"));
        FormInput2.setName("FormInput2"); // NOI18N
        FormInput2.setPreferredSize(new java.awt.Dimension(440, 115));
        FormInput2.setLayout(null);

        jLabel117.setText("No. Rawat :");
        jLabel117.setName("jLabel117"); // NOI18N
        FormInput2.add(jLabel117);
        jLabel117.setBounds(0, 20, 70, 23);

        txtNoRawat1.setEditable(false);
        txtNoRawat1.setHighlighter(null);
        txtNoRawat1.setName("txtNoRawat1"); // NOI18N
        txtNoRawat1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtNoRawat1KeyPressed(evt);
            }
        });
        FormInput2.add(txtNoRawat1);
        txtNoRawat1.setBounds(80, 20, 320, 23);

        txtNoRm1.setHighlighter(null);
        txtNoRm1.setName("txtNoRm1"); // NOI18N
        txtNoRm1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtNoRm1KeyPressed(evt);
            }
        });
        FormInput2.add(txtNoRm1);
        txtNoRm1.setBounds(520, 20, 110, 23);

        txtNamaPasien1.setEditable(false);
        txtNamaPasien1.setHighlighter(null);
        txtNamaPasien1.setName("txtNamaPasien1"); // NOI18N
        FormInput2.add(txtNamaPasien1);
        txtNamaPasien1.setBounds(632, 20, 270, 23);

        noKartuJkn1.setName("noKartuJkn1"); // NOI18N
        noKartuJkn1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                noKartuJkn1KeyPressed(evt);
            }
        });
        FormInput2.add(noKartuJkn1);
        noKartuJkn1.setBounds(80, 50, 320, 23);

        jLabel118.setText("No.Rekam Medik :");
        jLabel118.setName("jLabel118"); // NOI18N
        FormInput2.add(jLabel118);
        jLabel118.setBounds(416, 20, 100, 23);

        jLabel119.setText("No. Kartu: ");
        jLabel119.setName("jLabel119"); // NOI18N
        FormInput2.add(jLabel119);
        jLabel119.setBounds(0, 50, 70, 23);

        jLabel120.setText("Tgl.Lahir :");
        jLabel120.setName("jLabel120"); // NOI18N
        FormInput2.add(jLabel120);
        jLabel120.setBounds(460, 50, 60, 23);

        TglLahir1.setEditable(false);
        TglLahir1.setHighlighter(null);
        TglLahir1.setName("TglLahir1"); // NOI18N
        FormInput2.add(TglLahir1);
        TglLahir1.setBounds(520, 50, 110, 23);

        jLabel121.setText("J.K. :");
        jLabel121.setName("jLabel121"); // NOI18N
        FormInput2.add(jLabel121);
        jLabel121.setBounds(640, 50, 30, 23);

        Jk1.setEditable(false);
        Jk1.setHighlighter(null);
        Jk1.setName("Jk1"); // NOI18N
        FormInput2.add(Jk1);
        Jk1.setBounds(670, 50, 80, 23);

        internalFrameD1ataPasien1.add(FormInput2, java.awt.BorderLayout.PAGE_START);

        FormDataPelayanan1.setBorder(javax.swing.BorderFactory.createTitledBorder("Data Pelayanan"));
        FormDataPelayanan1.setName("FormDataPelayanan1"); // NOI18N
        FormDataPelayanan1.setPreferredSize(new java.awt.Dimension(490, 200));
        FormDataPelayanan1.setLayout(null);

        jLabel122.setText("Jns. Layanan :");
        jLabel122.setName("jLabel122"); // NOI18N
        FormDataPelayanan1.add(jLabel122);
        jLabel122.setBounds(0, 20, 80, 23);

        txtHakKelas1.setName("txtHakKelas1"); // NOI18N
        FormDataPelayanan1.add(txtHakKelas1);
        txtHakKelas1.setBounds(139, 80, 280, 23);

        jnsLayanan1.setEditable(false);
        jnsLayanan1.setHighlighter(null);
        jnsLayanan1.setName("jnsLayanan1"); // NOI18N
        jnsLayanan1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jnsLayanan1KeyPressed(evt);
            }
        });
        FormDataPelayanan1.add(jnsLayanan1);
        jnsLayanan1.setBounds(90, 20, 150, 23);

        jLabel123.setText("Kelas Rawat / Hak Kelas :");
        jLabel123.setName("jLabel123"); // NOI18N
        FormDataPelayanan1.add(jLabel123);
        jLabel123.setBounds(0, 80, 130, 23);

        txtNoSep1.setEditable(false);
        txtNoSep1.setHighlighter(null);
        txtNoSep1.setName("txtNoSep1"); // NOI18N
        FormDataPelayanan1.add(txtNoSep1);
        txtNoSep1.setBounds(660, 20, 380, 23);

        jLabel124.setText("Unit :");
        jLabel124.setName("jLabel124"); // NOI18N
        FormDataPelayanan1.add(jLabel124);
        jLabel124.setBounds(580, 50, 70, 23);

        nmPoli1.setEditable(false);
        nmPoli1.setName("nmPoli1"); // NOI18N
        FormDataPelayanan1.add(nmPoli1);
        nmPoli1.setBounds(720, 50, 320, 23);
        ...
        FormDataPelayanan1.add(kdPoli1);
        kdPoli1.setBounds(650, 50, 66, 23);

        jamMasuk1.setName("jamMasuk1"); // NOI18N
        jamMasuk1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jamMasuk1KeyPressed(evt);
            }
        });
        FormDataPelayanan1.add(jamMasuk1);
        jamMasuk1.setBounds(190, 50, 100, 23);

        jLabel125.setText("No. SEP :");
        jLabel125.setName("jLabel125"); // NOI18N
        FormDataPelayanan1.add(jLabel125);
        jLabel125.setBounds(590, 20, 60, 23);

        jLabel126.setText("Tgl. Masuk :");
        jLabel126.setName("jLabel126"); // NOI18N
        FormDataPelayanan1.add(jLabel126);
        jLabel126.setBounds(0, 50, 80, 23);

        tglMasuk1.setName("tglMasuk1"); // NOI18N
        tglMasuk1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tglMasuk1KeyPressed(evt);
            }
        });
        FormDataPelayanan1.add(tglMasuk1);
        tglMasuk1.setBounds(90, 50, 100, 23);

        jLabel127.setText("Tgl. Pulang :");
        jLabel127.setName("jLabel127"); // NOI18N
        FormDataPelayanan1.add(jLabel127);
        jLabel127.setBounds(290, 50, 80, 23);

        tglPulang1.setName("tglPulang1"); // NOI18N
        tglPulang1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tglPulang1KeyPressed(evt);
            }
        });
        FormDataPelayanan1.add(tglPulang1);
        tglPulang1.setBounds(370, 50, 100, 23);

        jamPulang1.setName("jamPulang1"); // NOI18N
        jamPulang1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jamPulang1KeyPressed(evt);
            }
        });
        FormDataPelayanan1.add(jamPulang1);
        jamPulang1.setBounds(470, 50, 100, 23);

        jLabel128.setText("DPJP :");
        jLabel128.setName("jLabel128"); // NOI18N
        FormDataPelayanan1.add(jLabel128);
        jLabel128.setBounds(0, 110, 70, 23);
        ...
        FormDataPelayanan1.add(kdDokter1);
        kdDokter1.setBounds(80, 110, 107, 23);

        nmDokter1.setEditable(false);
        nmDokter1.setName("nmDokter1"); // NOI18N
        FormDataPelayanan1.add(nmDokter1);
        nmDokter1.setBounds(190, 110, 230, 23);

        jLabel129.setText("Diastol :");
        jLabel129.setName("jLabel129"); // NOI18N
        FormDataPelayanan1.add(jLabel129);
        jLabel129.setBounds(810, 110, 90, 23);

        sistol1.setHighlighter(null);
        sistol1.setName("sistol1"); // NOI18N
        sistol1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                sistol1KeyPressed(evt);
            }
        });
        FormDataPelayanan1.add(sistol1);
        sistol1.setBounds(730, 110, 107, 23);

        diastol1.setName("diastol1"); // NOI18N
        FormDataPelayanan1.add(diastol1);
        diastol1.setBounds(900, 110, 140, 23);

        jLabel130.setText("Sistol :");
        jLabel130.setName("jLabel130"); // NOI18N
        FormDataPelayanan1.add(jLabel130);
        jLabel130.setBounds(650, 110, 70, 23);

        jLabel131.setText("Pasien TB :");
        jLabel131.setName("jLabel131"); // NOI18N
        FormDataPelayanan1.add(jLabel131);
        jLabel131.setBounds(0, 140, 70, 23);

        ChkPasienTB1.setBorder(null);
        ChkPasienTB1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ChkPasienTB1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        ChkPasienTB1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        ChkPasienTB1.setName("ChkPasienTB1"); // NOI18N
        ChkPasienTB1.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                ChkPasienTB1ItemStateChanged(evt);
            }
        });
        FormDataPelayanan1.add(ChkPasienTB1);
        ChkPasienTB1.setBounds(70, 140, 23, 23);

        txtIDSITB1.setHighlighter(null);
        txtIDSITB1.setName("txtIDSITB1"); // NOI18N
        txtIDSITB1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtIDSITB1KeyPressed(evt);
            }
        });
        FormDataPelayanan1.add(txtIDSITB1);
        txtIDSITB1.setBounds(95, 140, 210, 23);

        btnValidasiSITB1.setBackground(new java.awt.Color(0, 51, 102));
        btnValidasiSITB1.setForeground(new java.awt.Color(255, 255, 255));
        btnValidasiSITB1.setMnemonic('4');
        btnValidasiSITB1.setText("Validasi");
        btnValidasiSITB1.setToolTipText("Alt+4");
        btnValidasiSITB1.setName("btnValidasiSITB1"); // NOI18N
        btnValidasiSITB1.setOpaque(true);
        btnValidasiSITB1.setPreferredSize(new java.awt.Dimension(150, 23));
        btnValidasiSITB1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnValidasiSITB1ActionPerformed(evt);
            }
        });
        FormDataPelayanan1.add(btnValidasiSITB1);
        btnValidasiSITB1.setBounds(310, 140, 110, 23);

        jLabel132.setText("Kg");
        jLabel132.setName("jLabel132"); // NOI18N
        FormDataPelayanan1.add(jLabel132);
        jLabel132.setBounds(610, 110, 20, 23);

        beratLahir1.setText("0");
        beratLahir1.setHighlighter(null);
        beratLahir1.setName("beratLahir1"); // NOI18N
        beratLahir1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                beratLahir1KeyPressed(evt);
            }
        });
        FormDataPelayanan1.add(beratLahir1);
        beratLahir1.setBounds(500, 110, 107, 23);

        jLabel133.setText("Berat Lahir :");
        jLabel133.setName("jLabel133"); // NOI18N
        FormDataPelayanan1.add(jLabel133);
        jLabel133.setBounds(420, 110, 70, 23);

        jLabel134.setText("Cara. Pulang :");
        jLabel134.setName("jLabel134"); // NOI18N
        FormDataPelayanan1.add(jLabel134);
        jLabel134.setBounds(730, 80, 80, 23);

        panelNaikKelas1.setBorder(null);
        panelNaikKelas1.setName("panelNaikKelas1"); // NOI18N
        panelNaikKelas1.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT));

        jLabel135.setText("Kelas Layanan :");
        jLabel135.setName("jLabel135"); // NOI18N
        panelNaikKelas1.add(jLabel135);

        buttonGroupNaikKelas.add(R5);
        R5.setText("Kelas 3");
        R5.setName("R5"); // NOI18N
        R5.setPreferredSize(new java.awt.Dimension(80, 20));
        panelNaikKelas1.add(R5);

        buttonGroupNaikKelas.add(R6);
        R6.setText("Kelas 2");
        R6.setName("R6"); // NOI18N
        R6.setPreferredSize(new java.awt.Dimension(80, 16));
        panelNaikKelas1.add(R6);

        buttonGroupNaikKelas.add(R7);
        R7.setText("Kelas 1");
        R7.setName("R7"); // NOI18N
        R7.setPreferredSize(new java.awt.Dimension(80, 16));
        panelNaikKelas1.add(R7);

        buttonGroupNaikKelas.add(R8);
        R8.setText("Diatas Kelas 1");
        R8.setName("R8"); // NOI18N
        R8.setPreferredSize(new java.awt.Dimension(90, 16));
        panelNaikKelas1.add(R8);

        jLabel138.setText("Lama (hari) :");
        jLabel138.setName("jLabel138"); // NOI18N
        jLabel138.setPreferredSize(new java.awt.Dimension(150, 14));
        panelNaikKelas1.add(jLabel138);

        tarifPoliEksekutif3.setHighlighter(null);
        tarifPoliEksekutif3.setName("tarifPoliEksekutif3"); // NOI18N
        tarifPoliEksekutif3.setPreferredSize(new java.awt.Dimension(100, 24));
        tarifPoliEksekutif3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tarifPoliEksekutif3KeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tarifPoliEksekutif3KeyReleased(evt);
            }
        });
        panelNaikKelas1.add(tarifPoliEksekutif3);

        FormDataPelayanan1.add(panelNaikKelas1);
        panelNaikKelas1.setBounds(20, 170, 780, 30);

        panelCeklis1.setBorder(null);
        panelCeklis1.setName("panelCeklis1"); // NOI18N
        panelCeklis1.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT));

        chkEksekutif1.setBorder(null);
        chkEksekutif1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        chkEksekutif1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        chkEksekutif1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        chkEksekutif1.setName("chkEksekutif1"); // NOI18N
        chkEksekutif1.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                chkEksekutif1ItemStateChanged(evt);
            }
        });
        panelCeklis1.add(chkEksekutif1);

        jLabel139.setText("Kelas Eksekutif");
        jLabel139.setName("jLabel139"); // NOI18N
        panelCeklis1.add(jLabel139);

        chkNaikKelas1.setBorder(null);
        chkNaikKelas1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        chkNaikKelas1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        chkNaikKelas1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        chkNaikKelas1.setName("chkNaikKelas1"); // NOI18N
        chkNaikKelas1.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                chkNaikKelas1ItemStateChanged(evt);
            }
        });
        panelCeklis1.add(chkNaikKelas1);

        jLabel140.setText("Naik/Turun Kelas");
        jLabel140.setName("jLabel140"); // NOI18N
        panelCeklis1.add(jLabel140);

        chkIntensif1.setBorder(null);
        chkIntensif1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        chkIntensif1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        chkIntensif1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        chkIntensif1.setName("chkIntensif1"); // NOI18N
        chkIntensif1.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                chkIntensif1ItemStateChanged(evt);
            }
        });
        panelCeklis1.add(chkIntensif1);

        jLabel141.setText("Ada Rawat Intensif");
        jLabel141.setName("jLabel141"); // NOI18N
        panelCeklis1.add(jLabel141);

        FormDataPelayanan1.add(panelCeklis1);
        panelCeklis1.setBounds(240, 20, 320, 30);

        panelTarifPoliEksekutif1.setBorder(null);
        panelTarifPoliEksekutif1.setName("panelTarifPoliEksekutif1"); // NOI18N
        panelTarifPoliEksekutif1.setLayout(null);

        costPoliEksekutif1.setText("0");
        costPoliEksekutif1.setName("costPoliEksekutif1"); // NOI18N
        panelTarifPoliEksekutif1.add(costPoliEksekutif1);
        costPoliEksekutif1.setBounds(330, 5, 130, 23);

        tarifPoliEksekutif1.setText("0");
        tarifPoliEksekutif1.setHighlighter(null);
        tarifPoliEksekutif1.setName("tarifPoliEksekutif1"); // NOI18N
        tarifPoliEksekutif1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tarifPoliEksekutif1KeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tarifPoliEksekutif1KeyReleased(evt);
            }
        });
        panelTarifPoliEksekutif1.add(tarifPoliEksekutif1);
        tarifPoliEksekutif1.setBounds(120, 5, 170, 23);

        jLabel142.setText("Tarif Poli Eksekutif :");
        jLabel142.setName("jLabel142"); // NOI18N
        panelTarifPoliEksekutif1.add(jLabel142);
        jLabel142.setBounds(0, 5, 110, 23);

        jLabel143.setText("Rp. ");
        jLabel143.setName("jLabel143"); // NOI18N
        panelTarifPoliEksekutif1.add(jLabel143);
        jLabel143.setBounds(300, 5, 30, 23);

        FormDataPelayanan1.add(panelTarifPoliEksekutif1);
        panelTarifPoliEksekutif1.setBounds(20, 170, 620, 30);

        jLabel144.setText("Cara. Masuk :");
        jLabel144.setName("jLabel144"); // NOI18N
        FormDataPelayanan1.add(jLabel144);
        jLabel144.setBounds(420, 80, 80, 23);

        jLabel145.setText("Sub Acute :");
        jLabel145.setName("jLabel145"); // NOI18N
        FormDataPelayanan1.add(jLabel145);
        jLabel145.setBounds(440, 140, 60, 23);

        subAcute1.setText("-");
        subAcute1.setHighlighter(null);
        subAcute1.setName("subAcute1"); // NOI18N
        subAcute1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                subAcute1KeyPressed(evt);
            }
        });
        FormDataPelayanan1.add(subAcute1);
        subAcute1.setBounds(500, 140, 140, 23);

        jLabel146.setText("Chronic :");
        jLabel146.setName("jLabel146"); // NOI18N
        FormDataPelayanan1.add(jLabel146);
        jLabel146.setBounds(640, 140, 60, 23);

        chronic1.setText("-");
        chronic1.setHighlighter(null);
        chronic1.setName("chronic1"); // NOI18N
        chronic1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                chronic1KeyPressed(evt);
            }
        });
        FormDataPelayanan1.add(chronic1);
        chronic1.setBounds(700, 140, 140, 23);

        panelRawatIntensif1.setBorder(null);
        panelRawatIntensif1.setName("panelRawatIntensif1"); // NOI18N
        panelRawatIntensif1.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT));

        jLabel147.setText("Ventilator :");
        jLabel147.setName("jLabel147"); // NOI18N
        panelRawatIntensif1.add(jLabel147);

        chkVentilator1.setBorder(null);
        chkVentilator1.setText("Ya");
        chkVentilator1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        chkVentilator1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        chkVentilator1.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        chkVentilator1.setName("chkVentilator1"); // NOI18N
        chkVentilator1.setPreferredSize(new java.awt.Dimension(40, 14));
        chkVentilator1.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                chkVentilator1ItemStateChanged(evt);
            }
        });
        panelRawatIntensif1.add(chkVentilator1);

        jLabel148.setText("Intubasi :");
        jLabel148.setName("jLabel148"); // NOI18N
        jLabel148.setPreferredSize(new java.awt.Dimension(100, 14));
        panelRawatIntensif1.add(jLabel148);

        tglIntubasi1.setForeground(new java.awt.Color(50, 70, 50));
        tglIntubasi1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-10-2025 14:12:26" }));
        tglIntubasi1.setDisplayFormat("dd-MM-yyyy HH:mm:ss");
        tglIntubasi1.setName("tglIntubasi1"); // NOI18N
        tglIntubasi1.setOpaque(false);
        tglIntubasi1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tglIntubasi1KeyPressed(evt);
            }
        });
        panelRawatIntensif1.add(tglIntubasi1);

        jLabel149.setText("Ekstubasi :");
        jLabel149.setName("jLabel149"); // NOI18N
        jLabel149.setPreferredSize(new java.awt.Dimension(80, 14));
        panelRawatIntensif1.add(jLabel149);

        tglEkstubasi1.setForeground(new java.awt.Color(50, 70, 50));
        tglEkstubasi1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-10-2025 14:12:26" }));
        ...
        tglEkstubasi1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tglEkstubasi1KeyPressed(evt);
            }
        });
        panelRawatIntensif1.add(tglEkstubasi1);

        jLabel150.setText("Rawat Intensif  (hari) :");
        jLabel150.setName("jLabel150"); // NOI18N
        jLabel150.setPreferredSize(new java.awt.Dimension(150, 14));
        panelRawatIntensif1.add(jLabel150);

        icuLos1.setToolTipText("Untuk perbaikan tarif: Masukan total jumlah hari rawat intensif");
        icuLos1.setHighlighter(null);
        icuLos1.setName("icuLos1"); // NOI18N
        icuLos1.setPreferredSize(new java.awt.Dimension(100, 24));
        icuLos1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                icuLos1KeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                icuLos1KeyReleased(evt);
            }
        });
        panelRawatIntensif1.add(icuLos1);

        FormDataPelayanan1.add(panelRawatIntensif1);
        panelRawatIntensif1.setBounds(20, 210, 1080, 30);

        cmbCaraMasuk1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "gp | Rujukan FKTP", "osp-trans | Rujukan FKRTL", "mp | Rujukan Spesialis", "outp | Dari Rawat Jalan", "inp | Dari Rawat Inap", "emd | Dari Rawat Darurat", "born | Lahir di RS", "nursing | Rujukan Panti Jompo", "psych | Rujukan dari RS Jiwa", "rehab | Rujukan Fasilitas Rehab", "other | Lain-lain " }));
        cmbCaraMasuk1.setName("cmbCaraMasuk1"); // NOI18N
        cmbCaraMasuk1.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                cmbCaraMasuk1ItemStateChanged(evt);
            }
        });
        cmbCaraMasuk1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cmbCaraMasuk1KeyPressed(evt);
            }
        });
        FormDataPelayanan1.add(cmbCaraMasuk1);
        cmbCaraMasuk1.setBounds(500, 80, 230, 23);

        cmrCaraPulang1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Atas persetujuan dokter", "Dirujuk", "Atas permintaan sendiri", "Meninggal", "Lain-lain" }));
        cmrCaraPulang1.setName("cmrCaraPulang1"); // NOI18N
        cmrCaraPulang1.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                cmrCaraPulang1ItemStateChanged(evt);
            }
        });
        cmrCaraPulang1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cmrCaraPulang1KeyPressed(evt);
            }
        });
        FormDataPelayanan1.add(cmrCaraPulang1);
        cmrCaraPulang1.setBounds(810, 80, 230, 23);

        internalFrameD1ataPasien1.add(FormDataPelayanan1, java.awt.BorderLayout.CENTER);

        FormInput11.setBorder(javax.swing.BorderFactory.createTitledBorder("Tarif Layanan"));
        FormInput11.setName("FormInput11"); // NOI18N
        FormInput11.setPreferredSize(new java.awt.Dimension(490, 250));
        FormInput11.setLayout(null);

        jLabel151.setText("Total :");
        jLabel151.setName("jLabel151"); // NOI18N
        FormInput11.add(jLabel151);
        jLabel151.setBounds(0, 20, 80, 23);

        tfTenagaAhli1.setName("tfTenagaAhli1"); // NOI18N
        FormInput11.add(tfTenagaAhli1);
        tfTenagaAhli1.setBounds(110, 80, 270, 23);

        tfTotal1.setEditable(false);
        tfTotal1.setForeground(new java.awt.Color(255, 0, 51));
        tfTotal1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        tfTotal1.setHighlighter(null);
        tfTotal1.setName("tfTotal1"); // NOI18N
        tfTotal1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tfTotal1KeyPressed(evt);
            }
        });
        FormInput11.add(tfTotal1);
        tfTotal1.setBounds(90, 20, 310, 23);

        jLabel152.setText("Tenaga Ahli :");
        jLabel152.setName("jLabel152"); // NOI18N
        FormInput11.add(jLabel152);
        jLabel152.setBounds(-20, 80, 130, 23);

        jLabel153.setText("Prosedur Non Bedah :");
        jLabel153.setName("jLabel153"); // NOI18N
        FormInput11.add(jLabel153);
        jLabel153.setBounds(-20, 50, 130, 23);

        tfNonBedah1.setName("tfNonBedah1"); // NOI18N
        tfNonBedah1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tfNonBedah1KeyPressed(evt);
            }
        });
        FormInput11.add(tfNonBedah1);
        tfNonBedah1.setBounds(110, 50, 270, 23);

        jLabel154.setText("Radiologi :");
        jLabel154.setName("jLabel154"); // NOI18N
        FormInput11.add(jLabel154);
        jLabel154.setBounds(-20, 110, 130, 23);

        tfRadiologi1.setName("tfRadiologi1"); // NOI18N
        FormInput11.add(tfRadiologi1);
        tfRadiologi1.setBounds(110, 110, 270, 23);

        jLabel155.setText("Rehabilitasi :");
        jLabel155.setName("jLabel155"); // NOI18N
        FormInput11.add(jLabel155);
        jLabel155.setBounds(-20, 140, 130, 23);

        tfRehabilitasi1.setName("tfRehabilitasi1"); // NOI18N
        tfRehabilitasi1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tfRehabilitasi1KeyPressed(evt);
            }
        });
        FormInput11.add(tfRehabilitasi1);
        tfRehabilitasi1.setBounds(110, 140, 270, 23);

        tfObat1.setName("tfObat1"); // NOI18N
        FormInput11.add(tfObat1);
        tfObat1.setBounds(110, 170, 270, 23);

        jLabel156.setText("Obat :");
        jLabel156.setName("jLabel156"); // NOI18N
        FormInput11.add(jLabel156);
        jLabel156.setBounds(-20, 170, 130, 23);

        jLabel157.setText("Alkes :");
        jLabel157.setName("jLabel157"); // NOI18N
        FormInput11.add(jLabel157);
        jLabel157.setBounds(-20, 200, 130, 23);

        tfAlkes1.setName("tfAlkes1"); // NOI18N
        FormInput11.add(tfAlkes1);
        tfAlkes1.setBounds(110, 200, 270, 23);

        jLabel158.setText("Prosedur Bedah :");
        jLabel158.setName("jLabel158"); // NOI18N
        FormInput11.add(jLabel158);
        jLabel158.setBounds(370, 50, 110, 23);

        tfBedah1.setName("tfBedah1"); // NOI18N
        tfBedah1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tfBedah1KeyPressed(evt);
            }
        });
        FormInput11.add(tfBedah1);
        tfBedah1.setBounds(480, 50, 270, 23);

        tfKeperawatan1.setName("tfKeperawatan1"); // NOI18N
        FormInput11.add(tfKeperawatan1);
        tfKeperawatan1.setBounds(480, 80, 270, 23);

        jLabel159.setText("Keperawatan :");
        jLabel159.setName("jLabel159"); // NOI18N
        FormInput11.add(jLabel159);
        jLabel159.setBounds(370, 80, 110, 23);

        jLabel160.setText("Laboratorium :");
        jLabel160.setName("jLabel160"); // NOI18N
        FormInput11.add(jLabel160);
        jLabel160.setBounds(370, 110, 110, 23);

        tfLaboratorium1.setName("tfLaboratorium1"); // NOI18N
        FormInput11.add(tfLaboratorium1);
        tfLaboratorium1.setBounds(480, 110, 270, 23);

        jLabel161.setText("Konsultasi :");
        jLabel161.setName("jLabel161"); // NOI18N
        FormInput11.add(jLabel161);
        jLabel161.setBounds(740, 50, 100, 23);

        tfKonsultasi1.setName("tfKonsultasi1"); // NOI18N
        tfKonsultasi1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tfKonsultasi1KeyPressed(evt);
            }
        });
        FormInput11.add(tfKonsultasi1);
        tfKonsultasi1.setBounds(840, 50, 270, 23);

        tfPenunjang1.setName("tfPenunjang1"); // NOI18N
        FormInput11.add(tfPenunjang1);
        tfPenunjang1.setBounds(840, 80, 270, 23);

        jLabel162.setText("Penunjang :");
        jLabel162.setName("jLabel162"); // NOI18N
        FormInput11.add(jLabel162);
        jLabel162.setBounds(740, 80, 100, 23);

        jLabel163.setText(" Pelayanan Darah :");
        jLabel163.setName("jLabel163"); // NOI18N
        FormInput11.add(jLabel163);
        jLabel163.setBounds(740, 110, 100, 23);

        tfDarah1.setName("tfDarah1"); // NOI18N
        FormInput11.add(tfDarah1);
        tfDarah1.setBounds(840, 110, 270, 23);

        jLabel164.setText("Kamar / Akomodasi :");
        jLabel164.setName("jLabel164"); // NOI18N
        FormInput11.add(jLabel164);
        jLabel164.setBounds(370, 140, 110, 23);

        jLabel165.setText("Obat Kronis :");
        jLabel165.setName("jLabel165"); // NOI18N
        FormInput11.add(jLabel165);
        jLabel165.setBounds(370, 170, 110, 23);

        jLabel166.setText("BMHP :");
        jLabel166.setName("jLabel166"); // NOI18N
        FormInput11.add(jLabel166);
        jLabel166.setBounds(370, 200, 110, 23);

        tfBMHP1.setName("tfBMHP1"); // NOI18N
        FormInput11.add(tfBMHP1);
        tfBMHP1.setBounds(480, 200, 270, 23);

        tfObatKronis1.setName("tfObatKronis1"); // NOI18N
        FormInput11.add(tfObatKronis1);
        tfObatKronis1.setBounds(480, 170, 270, 23);

        tfKamar1.setName("tfKamar1"); // NOI18N
        tfKamar1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tfKamar1KeyPressed(evt);
            }
        });
        FormInput11.add(tfKamar1);
        tfKamar1.setBounds(480, 140, 270, 23);

        jLabel167.setText("Rawat Intensif :");
        jLabel167.setName("jLabel167"); // NOI18N
        FormInput11.add(jLabel167);
        jLabel167.setBounds(740, 140, 100, 23);

        tfRawatIntensif1.setName("tfRawatIntensif1"); // NOI18N
        tfRawatIntensif1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tfRawatIntensif1KeyPressed(evt);
            }
        });
        FormInput11.add(tfRawatIntensif1);
        tfRawatIntensif1.setBounds(840, 140, 270, 23);

        tfObatKemoterapi1.setName("tfObatKemoterapi1"); // NOI18N
        FormInput11.add(tfObatKemoterapi1);
        tfObatKemoterapi1.setBounds(840, 170, 270, 23);

        jLabel168.setText("Obat Kemoterapi :");
        jLabel168.setName("jLabel168"); // NOI18N
        FormInput11.add(jLabel168);
        jLabel168.setBounds(740, 170, 100, 23);

        jLabel169.setText("Sewa Alat :");
        jLabel169.setName("jLabel169"); // NOI18N
        FormInput11.add(jLabel169);
        jLabel169.setBounds(740, 200, 100, 23);

        tfSewaAlat1.setName("tfSewaAlat1"); // NOI18N
        FormInput11.add(tfSewaAlat1);
        tfSewaAlat1.setBounds(840, 200, 270, 23);

        internalFrameD1ataPasien1.add(FormInput11, java.awt.BorderLayout.PAGE_END);

        internalFrameDataPasien1.add(internalFrameD1ataPasien1, java.awt.BorderLayout.CENTER);

        internalFrame41.setName("internalFrame41"); // NOI18N
        internalFrame41.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT));

        setDataKlaim1.setBackground(new java.awt.Color(0, 0, 102));
        setDataKlaim1.setForeground(new java.awt.Color(255, 255, 255));
        setDataKlaim1.setMnemonic('4');
        setDataKlaim1.setText("Set Data Klaim");
        setDataKlaim1.setToolTipText("Alt+4");
        setDataKlaim1.setName("setDataKlaim1"); // NOI18N
        setDataKlaim1.setOpaque(true);
        setDataKlaim1.setPreferredSize(new java.awt.Dimension(150, 23));
        setDataKlaim1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                setDataKlaim1ActionPerformed(evt);
            }
        });
        internalFrame41.add(setDataKlaim1);

        btnUpdateDataKlaim1.setBackground(new java.awt.Color(204, 0, 255));
        btnUpdateDataKlaim1.setForeground(new java.awt.Color(255, 255, 255));
        btnUpdateDataKlaim1.setMnemonic('4');
        btnUpdateDataKlaim1.setText("Update Data Klaim");
        btnUpdateDataKlaim1.setToolTipText("Alt+4");
        btnUpdateDataKlaim1.setName("btnUpdateDataKlaim1"); // NOI18N
        btnUpdateDataKlaim1.setOpaque(true);
        btnUpdateDataKlaim1.setPreferredSize(new java.awt.Dimension(180, 23));
        btnUpdateDataKlaim1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnUpdateDataKlaim1ActionPerformed(evt);
            }
        });
        internalFrame41.add(btnUpdateDataKlaim1);

        btnImportDiagnosaDokter1.setBackground(new java.awt.Color(255, 204, 153));
        btnImportDiagnosaDokter1.setForeground(new java.awt.Color(0, 0, 0));
        btnImportDiagnosaDokter1.setMnemonic('4');
        btnImportDiagnosaDokter1.setText("Hasil Koding");
        btnImportDiagnosaDokter1.setToolTipText("Alt+4");
        btnImportDiagnosaDokter1.setName("btnImportDiagnosaDokter1"); // NOI18N
        btnImportDiagnosaDokter1.setOpaque(true);
        btnImportDiagnosaDokter1.setPreferredSize(new java.awt.Dimension(180, 23));
        btnImportDiagnosaDokter1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnImportDiagnosaDokter1ActionPerformed(evt);
            }
        });
        internalFrame41.add(btnImportDiagnosaDokter1);

        btnDiagnosaLocal1.setBackground(new java.awt.Color(255, 204, 153));
        btnDiagnosaLocal1.setForeground(new java.awt.Color(0, 0, 0));
        btnDiagnosaLocal1.setMnemonic('4');
        btnDiagnosaLocal1.setText("Input Diagnosa & Prosedur");
        btnDiagnosaLocal1.setToolTipText("Alt+4");
        btnDiagnosaLocal1.setName("btnDiagnosaLocal1"); // NOI18N
        btnDiagnosaLocal1.setOpaque(true);
        btnDiagnosaLocal1.setPreferredSize(new java.awt.Dimension(180, 23));
        btnDiagnosaLocal1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnDiagnosaLocal1ActionPerformed(evt);
            }
        });
        internalFrame41.add(btnDiagnosaLocal1);

        internalFrameDataPasien1.add(internalFrame41, java.awt.BorderLayout.PAGE_END);

        internalFrame7.add(internalFrameDataPasien1);
        internalFrameDataPasien1.setBounds(1, 1, 1120, 580);

        FrameKoding1.setName("FrameKoding1"); // NOI18N
        FrameKoding1.setLayout(null);

        FormKodingIDRG1.setBorder(null);
        FormKodingIDRG1.setName("FormKodingIDRG1"); // NOI18N
        FormKodingIDRG1.setLayout(null);

        FormInputIDRG1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "iDRG", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 12))); // NOI18N
        FormInputIDRG1.setName("FormInputIDRG1"); // NOI18N
        FormInputIDRG1.setPreferredSize(new java.awt.Dimension(490, 400));
        FormInputIDRG1.setLayout(new java.awt.BorderLayout());

        internalFrame42.setName("internalFrame42"); // NOI18N
        internalFrame42.setLayout(new java.awt.GridLayout(1, 0));

        internalFrame43.setBorder(null);
        internalFrame43.setName("internalFrame43"); // NOI18N
        internalFrame43.setLayout(new java.awt.BorderLayout(1, 1));

        internalFrame44.setName("internalFrame44"); // NOI18N
        internalFrame44.setLayout(new java.awt.BorderLayout());

        internalFrame45.setName("internalFrame45"); // NOI18N
        internalFrame45.setLayout(new java.awt.GridLayout(1, 0));

        Scroll21.setBorder(javax.swing.BorderFactory.createTitledBorder("Diagnosa"));
        Scroll21.setName("Scroll21"); // NOI18N
        Scroll21.setOpaque(true);

        tbDiagnosaIDRG1.setComponentPopupMenu(ppDiagnosaIDRG);
        tbDiagnosaIDRG1.setName("tbDiagnosaIDRG1"); // NOI18N
        Scroll21.setViewportView(tbDiagnosaIDRG1);

        internalFrame45.add(Scroll21);

        internalFrame44.add(internalFrame45, java.awt.BorderLayout.CENTER);

        internalFrame43.add(internalFrame44, java.awt.BorderLayout.CENTER);

        internalFrame42.add(internalFrame43);

        internalFrame46.setBorder(null);
        internalFrame46.setName("internalFrame46"); // NOI18N
        internalFrame46.setLayout(new java.awt.BorderLayout(1, 1));

        internalFrame47.setName("internalFrame47"); // NOI18N
        internalFrame47.setLayout(new java.awt.GridLayout(1, 0));

        Scroll22.setBorder(javax.swing.BorderFactory.createTitledBorder("Prosedur"));
        Scroll22.setName("Scroll22"); // NOI18N
        Scroll22.setOpaque(true);

        tbProsedurIDRG1.setComponentPopupMenu(ppProsedurIDRG);
        tbProsedurIDRG1.setName("tbProsedurIDRG1"); // NOI18N
        tbProsedurIDRG1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbProsedurIDRG1MouseClicked(evt);
            }
        });
        Scroll22.setViewportView(tbProsedurIDRG1);

        internalFrame47.add(Scroll22);

        internalFrame46.add(internalFrame47, java.awt.BorderLayout.CENTER);

        internalFrame42.add(internalFrame46);

        FormInputIDRG1.add(internalFrame42, java.awt.BorderLayout.CENTER);

        internalFrame48.setName("internalFrame48"); // NOI18N
        internalFrame48.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT));

        btnGroupingIDRG1.setBackground(new java.awt.Color(0, 0, 102));
        btnGroupingIDRG1.setForeground(new java.awt.Color(255, 255, 255));
        btnGroupingIDRG1.setMnemonic('4');
        btnGroupingIDRG1.setText("Grouping iDRG");
        btnGroupingIDRG1.setToolTipText("Alt+4");
        btnGroupingIDRG1.setName("btnGroupingIDRG1"); // NOI18N
        btnGroupingIDRG1.setOpaque(true);
        btnGroupingIDRG1.setPreferredSize(new java.awt.Dimension(150, 23));
        btnGroupingIDRG1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnGroupingIDRG1ActionPerformed(evt);
            }
        });
        internalFrame48.add(btnGroupingIDRG1);

        btnTambahDiagnosaIDRG1.setBackground(new java.awt.Color(255, 153, 0));
        btnTambahDiagnosaIDRG1.setForeground(new java.awt.Color(0, 0, 0));
        btnTambahDiagnosaIDRG1.setMnemonic('4');
        btnTambahDiagnosaIDRG1.setText("Tambah Diagnosa");
        btnTambahDiagnosaIDRG1.setToolTipText("Alt+4");
        btnTambahDiagnosaIDRG1.setName("btnTambahDiagnosaIDRG1"); // NOI18N
        btnTambahDiagnosaIDRG1.setOpaque(true);
        btnTambahDiagnosaIDRG1.setPreferredSize(new java.awt.Dimension(180, 23));
        btnTambahDiagnosaIDRG1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnTambahDiagnosaIDRG1ActionPerformed(evt);
            }
        });
        internalFrame48.add(btnTambahDiagnosaIDRG1);

        btnTambahProsedurIDRG1.setBackground(new java.awt.Color(51, 51, 255));
        btnTambahProsedurIDRG1.setForeground(new java.awt.Color(255, 255, 255));
        btnTambahProsedurIDRG1.setMnemonic('4');
        btnTambahProsedurIDRG1.setText("Tambah Prosedur");
        btnTambahProsedurIDRG1.setToolTipText("Alt+4");
        btnTambahProsedurIDRG1.setName("btnTambahProsedurIDRG1"); // NOI18N
        btnTambahProsedurIDRG1.setOpaque(true);
        btnTambahProsedurIDRG1.setPreferredSize(new java.awt.Dimension(180, 23));
        btnTambahProsedurIDRG1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnTambahProsedurIDRG1ActionPerformed(evt);
            }
        });
        internalFrame48.add(btnTambahProsedurIDRG1);

        FormInputIDRG1.add(internalFrame48, java.awt.BorderLayout.PAGE_END);

        FormKodingIDRG1.add(FormInputIDRG1);
        FormInputIDRG1.setBounds(0, 0, 1120, 350);

        FormInputHasilIDRG1.setBackground(new java.awt.Color(0, 255, 255));
        FormInputHasilIDRG1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Hasil Grouping iDRG", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 12))); // NOI18N
        FormInputHasilIDRG1.setName("FormInputHasilIDRG1"); // NOI18N
        FormInputHasilIDRG1.setPreferredSize(new java.awt.Dimension(490, 400));
        FormInputHasilIDRG1.setLayout(new java.awt.BorderLayout());

        internalFrame49.setBackground(new java.awt.Color(153, 255, 255));
        internalFrame49.setName("internalFrame49"); // NOI18N
        internalFrame49.setLayout(new java.awt.BorderLayout());

        internalFrame50.setBackground(new java.awt.Color(204, 204, 204));
        internalFrame50.setBorder(null);
        internalFrame50.setName("internalFrame50"); // NOI18N
        internalFrame50.setLayout(new java.awt.BorderLayout(1, 1));

        internalFrame51.setBackground(new java.awt.Color(153, 255, 255));
        internalFrame51.setName("internalFrame51"); // NOI18N
        internalFrame51.setLayout(new java.awt.BorderLayout());

        panelHasilIDRG1.setBorder(null);
        panelHasilIDRG1.setName("panelHasilIDRG1"); // NOI18N
        panelHasilIDRG1.setWarnaAtas(new java.awt.Color(204, 204, 204));
        panelHasilIDRG1.setWarnaBawah(new java.awt.Color(204, 204, 204));
        panelHasilIDRG1.setLayout(null);

        jLabel170.setForeground(new java.awt.Color(0, 0, 0));
        jLabel170.setText("Info :");
        jLabel170.setName("jLabel170"); // NOI18N
        panelHasilIDRG1.add(jLabel170);
        jLabel170.setBounds(0, 5, 70, 23);

        jLabel171.setForeground(new java.awt.Color(0, 0, 0));
        jLabel171.setText("Jenis Rawat :");
        jLabel171.setName("jLabel171"); // NOI18N
        panelHasilIDRG1.add(jLabel171);
        jLabel171.setBounds(0, 30, 70, 23);

        jLabel172.setForeground(new java.awt.Color(0, 0, 0));
        jLabel172.setText("MDC :");
        jLabel172.setName("jLabel172"); // NOI18N
        panelHasilIDRG1.add(jLabel172);
        jLabel172.setBounds(0, 55, 70, 23);

        jLabel173.setForeground(new java.awt.Color(0, 0, 0));
        jLabel173.setText("DRG :");
        jLabel173.setName("jLabel173"); // NOI18N
        panelHasilIDRG1.add(jLabel173);
        jLabel173.setBounds(0, 80, 70, 23);

        infoHasiliDRG1.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        infoHasiliDRG1.setForeground(new java.awt.Color(0, 0, 0));
        infoHasiliDRG1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        infoHasiliDRG1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        infoHasiliDRG1.setName("infoHasiliDRG1"); // NOI18N
        panelHasilIDRG1.add(infoHasiliDRG1);
        infoHasiliDRG1.setBounds(80, 5, 590, 23);

        jsnrawatHasiliDRG1.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        jsnrawatHasiliDRG1.setForeground(new java.awt.Color(0, 0, 0));
        jsnrawatHasiliDRG1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jsnrawatHasiliDRG1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jsnrawatHasiliDRG1.setName("jsnrawatHasiliDRG1"); // NOI18N
        panelHasilIDRG1.add(jsnrawatHasiliDRG1);
        jsnrawatHasiliDRG1.setBounds(80, 30, 590, 23);

        mdcCodeHasiliDRG1.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        mdcCodeHasiliDRG1.setForeground(new java.awt.Color(0, 0, 0));
        mdcCodeHasiliDRG1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        mdcCodeHasiliDRG1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        mdcCodeHasiliDRG1.setName("mdcCodeHasiliDRG1"); // NOI18N
        panelHasilIDRG1.add(mdcCodeHasiliDRG1);
        mdcCodeHasiliDRG1.setBounds(680, 55, 160, 23);

        mdcHasiliDRG1.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        mdcHasiliDRG1.setForeground(new java.awt.Color(0, 0, 0));
        mdcHasiliDRG1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        mdcHasiliDRG1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        mdcHasiliDRG1.setName("mdcHasiliDRG1"); // NOI18N
        panelHasilIDRG1.add(mdcHasiliDRG1);
        mdcHasiliDRG1.setBounds(80, 55, 590, 23);

        drgHasiliDRG1.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        drgHasiliDRG1.setForeground(new java.awt.Color(0, 0, 0));
        drgHasiliDRG1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        drgHasiliDRG1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        drgHasiliDRG1.setName("drgHasiliDRG1"); // NOI18N
        panelHasilIDRG1.add(drgHasiliDRG1);
        drgHasiliDRG1.setBounds(80, 80, 590, 23);

        drgCodeHasiliDRG1.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        drgCodeHasiliDRG1.setForeground(new java.awt.Color(0, 0, 0));
        drgCodeHasiliDRG1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        drgCodeHasiliDRG1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        drgCodeHasiliDRG1.setName("drgCodeHasiliDRG1"); // NOI18N
        panelHasilIDRG1.add(drgCodeHasiliDRG1);
        drgCodeHasiliDRG1.setBounds(680, 80, 160, 23);

        jLabel174.setForeground(new java.awt.Color(0, 0, 0));
        jLabel174.setText("Status :");
        jLabel174.setName("jLabel174"); // NOI18N
        panelHasilIDRG1.add(jLabel174);
        jLabel174.setBounds(0, 105, 70, 23);

        statusHasiliDRG1.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        statusHasiliDRG1.setForeground(new java.awt.Color(0, 0, 0));
        statusHasiliDRG1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        statusHasiliDRG1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        statusHasiliDRG1.setName("statusHasiliDRG1"); // NOI18N
        panelHasilIDRG1.add(statusHasiliDRG1);
        statusHasiliDRG1.setBounds(80, 105, 590, 23);

        btnFinalIDRG1.setBackground(new java.awt.Color(0, 102, 102));
        btnFinalIDRG1.setForeground(new java.awt.Color(255, 255, 255));
        btnFinalIDRG1.setMnemonic('4');
        btnFinalIDRG1.setText("Final iDRG");
        btnFinalIDRG1.setToolTipText("Alt+4");
        btnFinalIDRG1.setName("btnFinalIDRG1"); // NOI18N
        btnFinalIDRG1.setOpaque(true);
        btnFinalIDRG1.setPreferredSize(new java.awt.Dimension(150, 23));
        btnFinalIDRG1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnFinalIDRG1ActionPerformed(evt);
            }
        });
        panelHasilIDRG1.add(btnFinalIDRG1);
        btnFinalIDRG1.setBounds(10, 140, 150, 23);

        btnEditIDRG1.setBackground(new java.awt.Color(153, 0, 255));
        btnEditIDRG1.setForeground(new java.awt.Color(255, 255, 255));
        btnEditIDRG1.setMnemonic('4');
        btnEditIDRG1.setText("Edit iDRG");
        btnEditIDRG1.setToolTipText("Alt+4");
        btnEditIDRG1.setName("btnEditIDRG1"); // NOI18N
        btnEditIDRG1.setOpaque(true);
        btnEditIDRG1.setPreferredSize(new java.awt.Dimension(150, 23));
        btnEditIDRG1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnEditIDRG1ActionPerformed(evt);
            }
        });
        panelHasilIDRG1.add(btnEditIDRG1);
        btnEditIDRG1.setBounds(10, 140, 150, 23);

        internalFrame51.add(panelHasilIDRG1, java.awt.BorderLayout.CENTER);

        internalFrame50.add(internalFrame51, java.awt.BorderLayout.CENTER);

        internalFrame49.add(internalFrame50, java.awt.BorderLayout.CENTER);

        FormInputHasilIDRG1.add(internalFrame49, java.awt.BorderLayout.CENTER);

        FormKodingIDRG1.add(FormInputHasilIDRG1);
        FormInputHasilIDRG1.setBounds(0, 350, 1120, 200);

        FrameKoding1.add(FormKodingIDRG1);
        FormKodingIDRG1.setBounds(0, 0, 1310, 550);

        FormKodingINACBG1.setBorder(null);
        FormKodingINACBG1.setName("FormKodingINACBG1"); // NOI18N
        FormKodingINACBG1.setLayout(null);

        FormInputINACBG1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "INACBG", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 12))); // NOI18N
        FormInputINACBG1.setName("FormInputINACBG1"); // NOI18N
        FormInputINACBG1.setPreferredSize(new java.awt.Dimension(490, 400));
        FormInputINACBG1.setLayout(new java.awt.BorderLayout());

        internalFrame52.setName("internalFrame52"); // NOI18N
        internalFrame52.setLayout(new java.awt.GridLayout(1, 0));

        internalFrame53.setBorder(null);
        internalFrame53.setName("internalFrame53"); // NOI18N
        internalFrame53.setLayout(new java.awt.BorderLayout(1, 1));

        internalFrame54.setName("internalFrame54"); // NOI18N
        internalFrame54.setLayout(new java.awt.BorderLayout());

        Scroll23.setBorder(javax.swing.BorderFactory.createTitledBorder("Diagnosa"));
        Scroll23.setName("Scroll23"); // NOI18N
        Scroll23.setOpaque(true);

        tbDiagnosaIINACBG1.setComponentPopupMenu(ppDiagnosaINACBG);
        tbDiagnosaIINACBG1.setName("tbDiagnosaIINACBG1"); // NOI18N
        Scroll23.setViewportView(tbDiagnosaIINACBG1);

        internalFrame54.add(Scroll23, java.awt.BorderLayout.CENTER);

        internalFrame53.add(internalFrame54, java.awt.BorderLayout.CENTER);

        internalFrame52.add(internalFrame53);

        internalFrame55.setBorder(null);
        internalFrame55.setName("internalFrame55"); // NOI18N
        internalFrame55.setLayout(new java.awt.BorderLayout(1, 1));

        internalFrame56.setName("internalFrame56"); // NOI18N
        internalFrame56.setLayout(new java.awt.BorderLayout());

        Scroll24.setBorder(javax.swing.BorderFactory.createTitledBorder("Prosedur"));
        Scroll24.setName("Scroll24"); // NOI18N
        Scroll24.setOpaque(true);

        tbProsedureINACBG1.setComponentPopupMenu(ppProsedurINACBG);
        tbProsedureINACBG1.setName("tbProsedureINACBG1"); // NOI18N
        Scroll24.setViewportView(tbProsedureINACBG1);

        internalFrame56.add(Scroll24, java.awt.BorderLayout.CENTER);

        internalFrame55.add(internalFrame56, java.awt.BorderLayout.CENTER);

        internalFrame52.add(internalFrame55);

        FormInputINACBG1.add(internalFrame52, java.awt.BorderLayout.CENTER);

        internalFrame57.setName("internalFrame57"); // NOI18N
        internalFrame57.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT));

        btnImportToINACBG1.setBackground(new java.awt.Color(51, 255, 51));
        btnImportToINACBG1.setForeground(new java.awt.Color(0, 0, 0));
        btnImportToINACBG1.setMnemonic('4');
        btnImportToINACBG1.setText("Import Coding");
        btnImportToINACBG1.setToolTipText("Alt+4");
        btnImportToINACBG1.setName("btnImportToINACBG1"); // NOI18N
        btnImportToINACBG1.setOpaque(true);
        btnImportToINACBG1.setPreferredSize(new java.awt.Dimension(150, 23));
        btnImportToINACBG1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnImportToINACBG1ActionPerformed(evt);
            }
        });
        internalFrame57.add(btnImportToINACBG1);

        btnGroupingINACBG1.setBackground(new java.awt.Color(0, 0, 102));
        btnGroupingINACBG1.setForeground(new java.awt.Color(255, 255, 255));
        btnGroupingINACBG1.setMnemonic('4');
        btnGroupingINACBG1.setText("Grouping INACBG");
        btnGroupingINACBG1.setToolTipText("Alt+4");
        btnGroupingINACBG1.setName("btnGroupingINACBG1"); // NOI18N
        btnGroupingINACBG1.setOpaque(true);
        btnGroupingINACBG1.setPreferredSize(new java.awt.Dimension(180, 23));
        btnGroupingINACBG1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnGroupingINACBG1ActionPerformed(evt);
            }
        });
        internalFrame57.add(btnGroupingINACBG1);

        btnTabahDiagnosaINACBG1.setBackground(new java.awt.Color(255, 153, 0));
        btnTabahDiagnosaINACBG1.setForeground(new java.awt.Color(0, 0, 0));
        btnTabahDiagnosaINACBG1.setMnemonic('4');
        btnTabahDiagnosaINACBG1.setText("Tambah Diagnosa");
        btnTabahDiagnosaINACBG1.setToolTipText("Alt+4");
        btnTabahDiagnosaINACBG1.setName("btnTabahDiagnosaINACBG1"); // NOI18N
        btnTabahDiagnosaINACBG1.setOpaque(true);
        btnTabahDiagnosaINACBG1.setPreferredSize(new java.awt.Dimension(180, 23));
        btnTabahDiagnosaINACBG1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnTabahDiagnosaINACBG1ActionPerformed(evt);
            }
        });
        internalFrame57.add(btnTabahDiagnosaINACBG1);

        btnTambahProsedurINACBG1.setBackground(new java.awt.Color(51, 51, 255));
        btnTambahProsedurINACBG1.setForeground(new java.awt.Color(255, 255, 255));
        btnTambahProsedurINACBG1.setMnemonic('4');
        btnTambahProsedurINACBG1.setText("Tambah Prosedur");
        btnTambahProsedurINACBG1.setToolTipText("Alt+4");
        btnTambahProsedurINACBG1.setName("btnTambahProsedurINACBG1"); // NOI18N
        btnTambahProsedurINACBG1.setOpaque(true);
        btnTambahProsedurINACBG1.setPreferredSize(new java.awt.Dimension(180, 23));
        btnTambahProsedurINACBG1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnTambahProsedurINACBG1ActionPerformed(evt);
            }
        });
        internalFrame57.add(btnTambahProsedurINACBG1);

        FormInputINACBG1.add(internalFrame57, java.awt.BorderLayout.PAGE_END);

        FormKodingINACBG1.add(FormInputINACBG1);
        FormInputINACBG1.setBounds(0, 0, 1120, 350);

        FormInputHasilINACBG1.setBackground(new java.awt.Color(0, 255, 255));
        FormInputHasilINACBG1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Hasil Grouping INACBG", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 12))); // NOI18N
        FormInputHasilINACBG1.setName("FormInputHasilINACBG1"); // NOI18N
        FormInputHasilINACBG1.setPreferredSize(new java.awt.Dimension(490, 400));
        FormInputHasilINACBG1.setLayout(new java.awt.BorderLayout());

        internalFrame58.setBackground(new java.awt.Color(153, 255, 255));
        internalFrame58.setName("internalFrame58"); // NOI18N
        internalFrame58.setLayout(new java.awt.BorderLayout());

        internalFrame59.setBackground(new java.awt.Color(204, 204, 204));
        internalFrame59.setBorder(null);
        internalFrame59.setName("internalFrame59"); // NOI18N
        internalFrame59.setLayout(new java.awt.BorderLayout(1, 1));

        internalFrame60.setBackground(new java.awt.Color(153, 255, 255));
        internalFrame60.setName("internalFrame60"); // NOI18N
        internalFrame60.setLayout(new java.awt.BorderLayout());

        panelHasilINACBG2.setBorder(null);
        panelHasilINACBG2.setName("panelHasilINACBG2"); // NOI18N
        panelHasilINACBG2.setWarnaAtas(new java.awt.Color(204, 204, 204));
        panelHasilINACBG2.setWarnaBawah(new java.awt.Color(204, 204, 204));
        panelHasilINACBG2.setLayout(null);

        jLabel175.setForeground(new java.awt.Color(0, 0, 0));
        jLabel175.setText("Info :");
        jLabel175.setName("jLabel175"); // NOI18N
        panelHasilINACBG2.add(jLabel175);
        jLabel175.setBounds(0, 5, 120, 23);

        jLabel176.setForeground(new java.awt.Color(0, 0, 0));
        jLabel176.setText("Jenis Rawat :");
        jLabel176.setName("jLabel176"); // NOI18N
        panelHasilINACBG2.add(jLabel176);
        jLabel176.setBounds(0, 35, 120, 23);

        jLabel177.setForeground(new java.awt.Color(0, 0, 0));
        jLabel177.setText("Rp.");
        jLabel177.setName("jLabel177"); // NOI18N
        panelHasilINACBG2.add(jLabel177);
        jLabel177.setBounds(730, 65, 30, 23);

        jLabel178.setForeground(new java.awt.Color(0, 0, 0));
        jLabel178.setText("Sub Acute :");
        jLabel178.setName("jLabel178"); // NOI18N
        panelHasilINACBG2.add(jLabel178);
        jLabel178.setBounds(0, 90, 120, 23);

        jLabel179.setForeground(new java.awt.Color(0, 0, 0));
        jLabel179.setText("Chronic :");
        jLabel179.setName("jLabel179"); // NOI18N
        panelHasilINACBG2.add(jLabel179);
        jLabel179.setBounds(0, 115, 120, 23);

        jLabel180.setForeground(new java.awt.Color(0, 0, 0));
        jLabel180.setText("Special Procedure :");
        jLabel180.setName("jLabel180"); // NOI18N
        panelHasilINACBG2.add(jLabel180);
        jLabel180.setBounds(0, 140, 120, 23);

        jLabel181.setForeground(new java.awt.Color(0, 0, 0));
        jLabel181.setText("Special Prosthesis :");
        jLabel181.setName("jLabel181"); // NOI18N
        panelHasilINACBG2.add(jLabel181);
        jLabel181.setBounds(0, 165, 120, 23);

        jLabel182.setForeground(new java.awt.Color(0, 0, 0));
        jLabel182.setText("Special Investigation :");
        jLabel182.setName("jLabel182"); // NOI18N
        panelHasilINACBG2.add(jLabel182);
        jLabel182.setBounds(0, 190, 120, 23);

        jLabel183.setForeground(new java.awt.Color(0, 0, 0));
        jLabel183.setText("Special Drugs :");
        jLabel183.setName("jLabel183"); // NOI18N
        panelHasilINACBG2.add(jLabel183);
        jLabel183.setBounds(0, 215, 120, 23);

        jLabel184.setForeground(new java.awt.Color(0, 0, 0));
        jLabel184.setText("Total Klaim :");
        jLabel184.setName("jLabel184"); // NOI18N
        panelHasilINACBG2.add(jLabel184);
        jLabel184.setBounds(0, 240, 650, 23);

        jLabel185.setForeground(new java.awt.Color(0, 0, 0));
        jLabel185.setText("Status :");
        jLabel185.setName("jLabel185"); // NOI18N
        panelHasilINACBG2.add(jLabel185);
        jLabel185.setBounds(0, 260, 120, 23);

        btnFinalINACBG1.setBackground(new java.awt.Color(0, 102, 102));
        btnFinalINACBG1.setForeground(new java.awt.Color(255, 255, 255));
        btnFinalINACBG1.setMnemonic('4');
        btnFinalINACBG1.setText("Final INACBG");
        btnFinalINACBG1.setToolTipText("Alt+4");
        btnFinalINACBG1.setName("btnFinalINACBG1"); // NOI18N
        btnFinalINACBG1.setOpaque(true);
        btnFinalINACBG1.setPreferredSize(new java.awt.Dimension(150, 23));
        btnFinalINACBG1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnFinalINACBG1ActionPerformed(evt);
            }
        });
        panelHasilINACBG2.add(btnFinalINACBG1);
        btnFinalINACBG1.setBounds(10, 330, 150, 23);

        btnEditINACBG1.setBackground(new java.awt.Color(153, 0, 255));
        btnEditINACBG1.setForeground(new java.awt.Color(255, 255, 255));
        btnEditINACBG1.setMnemonic('4');
        btnEditINACBG1.setText("Edit INACBG");
        btnEditINACBG1.setToolTipText("Alt+4");
        btnEditINACBG1.setName("btnEditINACBG1"); // NOI18N
        btnEditINACBG1.setOpaque(true);
        btnEditINACBG1.setPreferredSize(new java.awt.Dimension(150, 23));
        btnEditINACBG1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnEditINACBG1ActionPerformed(evt);
            }
        });
        panelHasilINACBG2.add(btnEditINACBG1);
        btnEditINACBG1.setBounds(10, 330, 150, 23);

        infoHasilINACBG1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        infoHasilINACBG1.setForeground(new java.awt.Color(0, 0, 0));
        infoHasilINACBG1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        infoHasilINACBG1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        infoHasilINACBG1.setName("infoHasilINACBG1"); // NOI18N
        panelHasilINACBG2.add(infoHasilINACBG1);
        infoHasilINACBG1.setBounds(120, 5, 810, 23);

        jnsrawatHasilINACBG1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jnsrawatHasilINACBG1.setForeground(new java.awt.Color(0, 0, 0));
        jnsrawatHasilINACBG1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jnsrawatHasilINACBG1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jnsrawatHasilINACBG1.setName("jnsrawatHasilINACBG1"); // NOI18N
        panelHasilINACBG2.add(jnsrawatHasilINACBG1);
        jnsrawatHasilINACBG1.setBounds(120, 35, 460, 23);

        groupHasilINACBG1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        groupHasilINACBG1.setForeground(new java.awt.Color(0, 0, 0));
        groupHasilINACBG1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        groupHasilINACBG1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        groupHasilINACBG1.setName("groupHasilINACBG1"); // NOI18N
        panelHasilINACBG2.add(groupHasilINACBG1);
        groupHasilINACBG1.setBounds(120, 65, 460, 23);

        groupCodeHasilINACBG3.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        groupCodeHasilINACBG3.setForeground(new java.awt.Color(0, 0, 0));
        groupCodeHasilINACBG3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        groupCodeHasilINACBG3.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        groupCodeHasilINACBG3.setName("groupCodeHasilINACBG3"); // NOI18N
        panelHasilINACBG2.add(groupCodeHasilINACBG3);
        groupCodeHasilINACBG3.setBounds(590, 65, 140, 23);

        groupCostHasilINACBG3.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        groupCostHasilINACBG3.setForeground(new java.awt.Color(0, 0, 0));
        groupCostHasilINACBG3.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        groupCostHasilINACBG3.setName("groupCostHasilINACBG3"); // NOI18N
        panelHasilINACBG2.add(groupCostHasilINACBG3);
        groupCostHasilINACBG3.setBounds(760, 65, 170, 23);

        jLabel186.setForeground(new java.awt.Color(0, 0, 0));
        jLabel186.setText("Group :");
        jLabel186.setName("jLabel186"); // NOI18N
        panelHasilINACBG2.add(jLabel186);
        jLabel186.setBounds(0, 65, 120, 23);

        jLabel187.setForeground(new java.awt.Color(0, 0, 0));
        jLabel187.setText("Rp.");
        jLabel187.setName("jLabel187"); // NOI18N
        panelHasilINACBG2.add(jLabel187);
        jLabel187.setBounds(730, 90, 30, 23);

        groupCostHasilINACBG4.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        groupCostHasilINACBG4.setForeground(new java.awt.Color(0, 0, 0));
        groupCostHasilINACBG4.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        groupCostHasilINACBG4.setName("groupCostHasilINACBG4"); // NOI18N
        panelHasilINACBG2.add(groupCostHasilINACBG4);
        groupCostHasilINACBG4.setBounds(760, 90, 170, 23);

        groupCodeHasilINACBG4.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        groupCodeHasilINACBG4.setForeground(new java.awt.Color(0, 0, 0));
        groupCodeHasilINACBG4.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        groupCodeHasilINACBG4.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        groupCodeHasilINACBG4.setName("groupCodeHasilINACBG4"); // NOI18N
        panelHasilINACBG2.add(groupCodeHasilINACBG4);
        groupCodeHasilINACBG4.setBounds(590, 90, 140, 23);

        subAcuteHasilINACBG1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        subAcuteHasilINACBG1.setForeground(new java.awt.Color(0, 0, 0));
        subAcuteHasilINACBG1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        subAcuteHasilINACBG1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        subAcuteHasilINACBG1.setName("subAcuteHasilINACBG1"); // NOI18N
        panelHasilINACBG2.add(subAcuteHasilINACBG1);
        subAcuteHasilINACBG1.setBounds(120, 90, 460, 23);

        chronicHasilINACBG1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        chronicHasilINACBG1.setForeground(new java.awt.Color(0, 0, 0));
        chronicHasilINACBG1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        chronicHasilINACBG1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        chronicHasilINACBG1.setName("chronicHasilINACBG1"); // NOI18N
        panelHasilINACBG2.add(chronicHasilINACBG1);
        chronicHasilINACBG1.setBounds(120, 115, 460, 23);

        groupCodeHasilINACBG6.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        groupCodeHasilINACBG6.setForeground(new java.awt.Color(0, 0, 0));
        groupCodeHasilINACBG6.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        groupCodeHasilINACBG6.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        groupCodeHasilINACBG6.setName("groupCodeHasilINACBG6"); // NOI18N
        panelHasilINACBG2.add(groupCodeHasilINACBG6);
        groupCodeHasilINACBG6.setBounds(590, 115, 140, 23);

        jLabel188.setForeground(new java.awt.Color(0, 0, 0));
        jLabel188.setText("Rp.");
        jLabel188.setName("jLabel188"); // NOI18N
        panelHasilINACBG2.add(jLabel188);
        jLabel188.setBounds(730, 115, 30, 23);

        groupCostHasilINACBG7.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        groupCostHasilINACBG7.setForeground(new java.awt.Color(0, 0, 0));
        groupCostHasilINACBG7.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        groupCostHasilINACBG7.setName("groupCostHasilINACBG7"); // NOI18N
        panelHasilINACBG2.add(groupCostHasilINACBG7);
        groupCostHasilINACBG7.setBounds(760, 115, 170, 23);

        SpecialProcedureHasilCode1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        SpecialProcedureHasilCode1.setForeground(new java.awt.Color(0, 0, 0));
        SpecialProcedureHasilCode1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        SpecialProcedureHasilCode1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        SpecialProcedureHasilCode1.setName("SpecialProcedureHasilCode1"); // NOI18N
        panelHasilINACBG2.add(SpecialProcedureHasilCode1);
        SpecialProcedureHasilCode1.setBounds(590, 140, 140, 23);

        jLabel189.setForeground(new java.awt.Color(0, 0, 0));
        jLabel189.setText("Rp.");
        jLabel189.setName("jLabel189"); // NOI18N
        panelHasilINACBG2.add(jLabel189);
        jLabel189.setBounds(730, 140, 30, 23);

        SpecialProcedureHasilCost1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        SpecialProcedureHasilCost1.setForeground(new java.awt.Color(0, 0, 0));
        SpecialProcedureHasilCost1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        SpecialProcedureHasilCost1.setName("SpecialProcedureHasilCost1"); // NOI18N
        panelHasilINACBG2.add(SpecialProcedureHasilCost1);
        SpecialProcedureHasilCost1.setBounds(760, 140, 170, 23);

        SpecialProsthesisHasilCode1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        SpecialProsthesisHasilCode1.setForeground(new java.awt.Color(0, 0, 0));
        SpecialProsthesisHasilCode1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        SpecialProsthesisHasilCode1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        SpecialProsthesisHasilCode1.setName("SpecialProsthesisHasilCode1"); // NOI18N
        panelHasilINACBG2.add(SpecialProsthesisHasilCode1);
        SpecialProsthesisHasilCode1.setBounds(590, 165, 140, 23);

        jLabel190.setForeground(new java.awt.Color(0, 0, 0));
        jLabel190.setText("Rp.");
        jLabel190.setName("jLabel190"); // NOI18N
        panelHasilINACBG2.add(jLabel190);
        jLabel190.setBounds(730, 165, 30, 23);

        SpecialProsthesisHasilCost1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        SpecialProsthesisHasilCost1.setForeground(new java.awt.Color(0, 0, 0));
        SpecialProsthesisHasilCost1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        SpecialProsthesisHasilCost1.setName("SpecialProsthesisHasilCost1"); // NOI18N
        panelHasilINACBG2.add(SpecialProsthesisHasilCost1);
        SpecialProsthesisHasilCost1.setBounds(760, 165, 170, 23);

        groupCodeHasilINACBG8.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        groupCodeHasilINACBG8.setForeground(new java.awt.Color(0, 0, 0));
        groupCodeHasilINACBG8.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        groupCodeHasilINACBG8.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        groupCodeHasilINACBG8.setName("groupCodeHasilINACBG8"); // NOI18N
        panelHasilINACBG2.add(groupCodeHasilINACBG8);
        groupCodeHasilINACBG8.setBounds(590, 190, 140, 23);

        jLabel191.setForeground(new java.awt.Color(0, 0, 0));
        jLabel191.setText("Rp.");
        jLabel191.setName("jLabel191"); // NOI18N
        panelHasilINACBG2.add(jLabel191);
        jLabel191.setBounds(730, 190, 30, 23);

        groupCostHasilINACBG8.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        groupCostHasilINACBG8.setForeground(new java.awt.Color(0, 0, 0));
        groupCostHasilINACBG8.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        groupCostHasilINACBG8.setName("groupCostHasilINACBG8"); // NOI18N
        panelHasilINACBG2.add(groupCostHasilINACBG8);
        groupCostHasilINACBG8.setBounds(760, 190, 170, 23);

        statusHasilInacbg1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        statusHasilInacbg1.setForeground(new java.awt.Color(0, 0, 0));
        statusHasilInacbg1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        statusHasilInacbg1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        statusHasilInacbg1.setName("statusHasilInacbg1"); // NOI18N
        panelHasilINACBG2.add(statusHasilInacbg1);
        statusHasilInacbg1.setBounds(120, 260, 460, 23);

        jLabel192.setForeground(new java.awt.Color(0, 0, 0));
        jLabel192.setText("Rp.");
        jLabel192.setName("jLabel192"); // NOI18N
        panelHasilINACBG2.add(jLabel192);
        jLabel192.setBounds(730, 215, 30, 23);

        groupCostHasilINACBG9.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        groupCostHasilINACBG9.setForeground(new java.awt.Color(0, 0, 0));
        groupCostHasilINACBG9.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        groupCostHasilINACBG9.setName("groupCostHasilINACBG9"); // NOI18N
        panelHasilINACBG2.add(groupCostHasilINACBG9);
        groupCostHasilINACBG9.setBounds(760, 215, 170, 23);

        CmbSpecialProcedure1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "None" }));
        CmbSpecialProcedure1.setName("CmbSpecialProcedure1"); // NOI18N
        CmbSpecialProcedure1.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                CmbSpecialProcedure1ItemStateChanged(evt);
            }
        });
        CmbSpecialProcedure1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                CmbSpecialProcedure1KeyPressed(evt);
            }
        });
        panelHasilINACBG2.add(CmbSpecialProcedure1);
        CmbSpecialProcedure1.setBounds(120, 140, 460, 23);

        CmbSpecialProsthesis1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "None" }));
        CmbSpecialProsthesis1.setName("CmbSpecialProsthesis1"); // NOI18N
        CmbSpecialProsthesis1.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                CmbSpecialProsthesis1ItemStateChanged(evt);
            }
        });
        CmbSpecialProsthesis1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                CmbSpecialProsthesis1KeyPressed(evt);
            }
        });
        panelHasilINACBG2.add(CmbSpecialProsthesis1);
        CmbSpecialProsthesis1.setBounds(120, 165, 460, 23);

        CmbSpecialInvestigation1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "None" }));
        CmbSpecialInvestigation1.setName("CmbSpecialInvestigation1"); // NOI18N
        CmbSpecialInvestigation1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                CmbSpecialInvestigation1KeyPressed(evt);
            }
        });
        panelHasilINACBG2.add(CmbSpecialInvestigation1);
        CmbSpecialInvestigation1.setBounds(120, 190, 460, 23);

        CmbSpeciaDrugs1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "None" }));
        CmbSpeciaDrugs1.setName("CmbSpeciaDrugs1"); // NOI18N
        CmbSpeciaDrugs1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                CmbSpeciaDrugs1KeyPressed(evt);
            }
        });
        panelHasilINACBG2.add(CmbSpeciaDrugs1);
        CmbSpeciaDrugs1.setBounds(120, 215, 460, 23);

        totalCostHasilKlaim1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        totalCostHasilKlaim1.setForeground(new java.awt.Color(0, 0, 0));
        totalCostHasilKlaim1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        totalCostHasilKlaim1.setName("totalCostHasilKlaim1"); // NOI18N
        panelHasilINACBG2.add(totalCostHasilKlaim1);
        totalCostHasilKlaim1.setBounds(760, 240, 170, 23);

        jLabel193.setForeground(new java.awt.Color(0, 0, 0));
        jLabel193.setText("Rp.");
        jLabel193.setName("jLabel193"); // NOI18N
        panelHasilINACBG2.add(jLabel193);
        jLabel193.setBounds(730, 240, 30, 23);

        groupCodeHasilINACBG9.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        groupCodeHasilINACBG9.setForeground(new java.awt.Color(0, 0, 0));
        groupCodeHasilINACBG9.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        groupCodeHasilINACBG9.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        groupCodeHasilINACBG9.setName("groupCodeHasilINACBG9"); // NOI18N
        panelHasilINACBG2.add(groupCodeHasilINACBG9);
        groupCodeHasilINACBG9.setBounds(590, 215, 140, 23);

        internalFrame60.add(panelHasilINACBG2, java.awt.BorderLayout.CENTER);

        internalFrame59.add(internalFrame60, java.awt.BorderLayout.CENTER);

        internalFrame58.add(internalFrame59, java.awt.BorderLayout.CENTER);

        FormInputHasilINACBG1.add(internalFrame58, java.awt.BorderLayout.CENTER);

        FormKodingINACBG1.add(FormInputHasilINACBG1);
        FormInputHasilINACBG1.setBounds(0, 350, 1120, 390);

        FormInputStatusKlaim1.setBackground(new java.awt.Color(0, 255, 255));
        FormInputStatusKlaim1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Status Klaim", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 12))); // NOI18N
        FormInputStatusKlaim1.setName("FormInputStatusKlaim1"); // NOI18N
        FormInputStatusKlaim1.setPreferredSize(new java.awt.Dimension(490, 400));
        FormInputStatusKlaim1.setLayout(new java.awt.BorderLayout());

        internalFrame61.setBackground(new java.awt.Color(153, 255, 255));
        internalFrame61.setName("internalFrame61"); // NOI18N
        internalFrame61.setLayout(new java.awt.BorderLayout());

        internalFrame62.setBackground(new java.awt.Color(204, 204, 204));
        internalFrame62.setBorder(null);
        internalFrame62.setName("internalFrame62"); // NOI18N
        internalFrame62.setLayout(new java.awt.BorderLayout(1, 1));

        internalFrame63.setBackground(new java.awt.Color(153, 255, 255));
        internalFrame63.setName("internalFrame63"); // NOI18N
        internalFrame63.setLayout(new java.awt.BorderLayout());

        panelHasilINACBG3.setBorder(null);
        panelHasilINACBG3.setName("panelHasilINACBG3"); // NOI18N
        panelHasilINACBG3.setWarnaAtas(new java.awt.Color(204, 204, 204));
        panelHasilINACBG3.setWarnaBawah(new java.awt.Color(204, 204, 204));
        panelHasilINACBG3.setLayout(null);

        jLabel194.setForeground(new java.awt.Color(0, 0, 0));
        jLabel194.setText("Status Klaim :");
        jLabel194.setName("jLabel194"); // NOI18N
        panelHasilINACBG3.add(jLabel194);
        jLabel194.setBounds(0, 5, 120, 23);

        jLabel195.setForeground(new java.awt.Color(0, 0, 0));
        jLabel195.setText("Status DC Kemkes :");
        jLabel195.setName("jLabel195"); // NOI18N
        panelHasilINACBG3.add(jLabel195);
        jLabel195.setBounds(0, 35, 120, 23);

        statusKlaim1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        statusKlaim1.setForeground(new java.awt.Color(0, 0, 0));
        statusKlaim1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        statusKlaim1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        statusKlaim1.setName("statusKlaim1"); // NOI18N
        panelHasilINACBG3.add(statusKlaim1);
        statusKlaim1.setBounds(120, 5, 460, 23);

        statusDC1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        statusDC1.setForeground(new java.awt.Color(0, 0, 0));
        statusDC1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        statusDC1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        statusDC1.setName("statusDC1"); // NOI18N
        panelHasilINACBG3.add(statusDC1);
        statusDC1.setBounds(120, 35, 460, 23);

        internalFrame63.add(panelHasilINACBG3, java.awt.BorderLayout.CENTER);

        internalFrame62.add(internalFrame63, java.awt.BorderLayout.CENTER);

        internalFrame61.add(internalFrame62, java.awt.BorderLayout.CENTER);

        FormInputStatusKlaim1.add(internalFrame61, java.awt.BorderLayout.CENTER);

        FormKodingINACBG1.add(FormInputStatusKlaim1);
        FormInputStatusKlaim1.setBounds(0, 740, 1120, 100);

        internalFrameEndKlaim1.setName("internalFrameEndKlaim1"); // NOI18N
        internalFrameEndKlaim1.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT));

        btnEditKlaim1.setBackground(new java.awt.Color(153, 0, 255));
        btnEditKlaim1.setForeground(new java.awt.Color(255, 255, 255));
        btnEditKlaim1.setMnemonic('4');
        btnEditKlaim1.setText("Edit Klaim");
        btnEditKlaim1.setToolTipText("Alt+4");
        btnEditKlaim1.setName("btnEditKlaim1"); // NOI18N
        btnEditKlaim1.setOpaque(true);
        btnEditKlaim1.setPreferredSize(new java.awt.Dimension(150, 23));
        btnEditKlaim1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnEditKlaim1ActionPerformed(evt);
            }
        });
        internalFrameEndKlaim1.add(btnEditKlaim1);

        btnFinalKlaim1.setBackground(new java.awt.Color(255, 0, 0));
        btnFinalKlaim1.setForeground(new java.awt.Color(255, 255, 255));
        btnFinalKlaim1.setMnemonic('4');
        btnFinalKlaim1.setText("Final Klaim");
        btnFinalKlaim1.setToolTipText("Alt+4");
        btnFinalKlaim1.setName("btnFinalKlaim1"); // NOI18N
        btnFinalKlaim1.setOpaque(true);
        btnFinalKlaim1.setPreferredSize(new java.awt.Dimension(150, 23));
        btnFinalKlaim1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnFinalKlaim1ActionPerformed(evt);
            }
        });
        internalFrameEndKlaim1.add(btnFinalKlaim1);

        btnKirimOnline1.setBackground(new java.awt.Color(51, 255, 51));
        btnKirimOnline1.setForeground(new java.awt.Color(0, 0, 0));
        btnKirimOnline1.setMnemonic('4');
        btnKirimOnline1.setText("Kirim Online");
        btnKirimOnline1.setToolTipText("Alt+4");
        btnKirimOnline1.setName("btnKirimOnline1"); // NOI18N
        btnKirimOnline1.setOpaque(true);
        btnKirimOnline1.setPreferredSize(new java.awt.Dimension(150, 23));
        btnKirimOnline1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnKirimOnline1ActionPerformed(evt);
            }
        });
        internalFrameEndKlaim1.add(btnKirimOnline1);

        btnCetakKlaim1.setBackground(new java.awt.Color(0, 153, 153));
        btnCetakKlaim1.setForeground(new java.awt.Color(255, 255, 255));
        btnCetakKlaim1.setMnemonic('S');
        btnCetakKlaim1.setText("Cetak Klaim ");
        btnCetakKlaim1.setToolTipText("Alt+S");
        btnCetakKlaim1.setName("btnCetakKlaim1"); // NOI18N
        btnCetakKlaim1.setOpaque(true);
        btnCetakKlaim1.setPreferredSize(new java.awt.Dimension(150, 23));
        btnCetakKlaim1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCetakKlaim1ActionPerformed(evt);
            }
        });
        btnCetakKlaim1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                btnCetakKlaim1KeyPressed(evt);
            }
        });
        internalFrameEndKlaim1.add(btnCetakKlaim1);

        btnHasilFinalKlaim1.setBackground(new java.awt.Color(255, 153, 0));
        btnHasilFinalKlaim1.setForeground(new java.awt.Color(0, 0, 0));
        btnHasilFinalKlaim1.setMnemonic('S');
        btnHasilFinalKlaim1.setText("Hasil Klaim Final");
        btnHasilFinalKlaim1.setToolTipText("Alt+S");
        btnHasilFinalKlaim1.setName("btnHasilFinalKlaim1"); // NOI18N
        btnHasilFinalKlaim1.setOpaque(true);
        btnHasilFinalKlaim1.setPreferredSize(new java.awt.Dimension(200, 23));
        btnHasilFinalKlaim1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnHasilFinalKlaim1ActionPerformed(evt);
            }
        });
        btnHasilFinalKlaim1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                btnHasilFinalKlaim1KeyPressed(evt);
            }
        });
        internalFrameEndKlaim1.add(btnHasilFinalKlaim1);

        FormKodingINACBG1.add(internalFrameEndKlaim1);
        internalFrameEndKlaim1.setBounds(0, 840, 1120, 35);

        FrameKoding1.add(FormKodingINACBG1);
        FormKodingINACBG1.setBounds(0, 550, 1310, 950);

        internalFrame7.add(FrameKoding1);
        FrameKoding1.setBounds(0, 580, 1120, 2500);
        ...
        internalFrame7.add(jScrollPane9);
        jScrollPane9.setBounds(1130, 20, 300, 60);

        jLabel196.setText("Jalannya Penyakit");
        jLabel196.setName("jLabel196"); // NOI18N
        internalFrame7.add(jLabel196);
        jLabel196.setBounds(1140, 190, 130, 16);

        jLabel197.setText("Diagnosa Utama");
        jLabel197.setName("jLabel197"); // NOI18N
        internalFrame7.add(jLabel197);
        jLabel197.setBounds(1440, 90, 120, 16);
        ...
        internalFrame7.add(jScrollPane10);
        jScrollPane10.setBounds(1130, 110, 300, 70);
        ...
        internalFrame7.add(jScrollPane11);
        jScrollPane11.setBounds(1130, 210, 300, 70);

        jLabel198.setText("Pemeriksaan Fisik");
        jLabel198.setName("jLabel198"); // NOI18N
        internalFrame7.add(jLabel198);
        jLabel198.setBounds(1140, 90, 130, 16);

        jLabel199.setText("Permeriksaan RAD");
        jLabel199.setName("jLabel199"); // NOI18N
        internalFrame7.add(jLabel199);
        jLabel199.setBounds(1140, 290, 130, 16);
        ...
        internalFrame7.add(jScrollPane12);
        jScrollPane12.setBounds(1130, 310, 300, 70);
        ...
        internalFrame7.add(jScrollPane13);
        jScrollPane13.setBounds(1130, 410, 300, 70);

        jLabel200.setText("Pemeriksaan LAB");
        jLabel200.setName("jLabel200"); // NOI18N
        internalFrame7.add(jLabel200);
        jLabel200.setBounds(1140, 390, 130, 16);

        jLabel201.setText("Tindakan Operasi");
        jLabel201.setName("jLabel201"); // NOI18N
        internalFrame7.add(jLabel201);
        jLabel201.setBounds(1140, 490, 130, 16);
        ...
        internalFrame7.add(jScrollPane14);
        jScrollPane14.setBounds(1130, 510, 300, 70);

        jLabel202.setText("Obat- obatan");
        jLabel202.setName("jLabel202"); // NOI18N
        internalFrame7.add(jLabel202);
        jLabel202.setBounds(1140, 590, 130, 16);
        ...
        internalFrame7.add(jScrollPane15);
        jScrollPane15.setBounds(1130, 610, 300, 70);

        jTextField6.setName("jTextField6"); // NOI18N
        internalFrame7.add(jTextField6);
        jTextField6.setBounds(1440, 110, 220, 22);

        jLabel203.setText("Keluhan Utama");
        jLabel203.setName("jLabel203"); // NOI18N
        internalFrame7.add(jLabel203);
        jLabel203.setBounds(1140, 0, 90, 16);

        jTextField7.setName("jTextField7"); // NOI18N
        internalFrame7.add(jTextField7);
        jTextField7.setBounds(1440, 160, 220, 22);

        jLabel204.setText("Diagnosa Sekunder 1");
        jLabel204.setName("jLabel204"); // NOI18N
        internalFrame7.add(jLabel204);
        jLabel204.setBounds(1440, 140, 140, 16);

        jLabel205.setText("Diagnosa Sekunder 2");
        jLabel205.setName("jLabel205"); // NOI18N
        internalFrame7.add(jLabel205);
        jLabel205.setBounds(1440, 190, 140, 16);

        jTextField8.setName("jTextField8"); // NOI18N
        internalFrame7.add(jTextField8);
        jTextField8.setBounds(1440, 210, 220, 22);

        jTextField9.setName("jTextField9"); // NOI18N
        internalFrame7.add(jTextField9);
        jTextField9.setBounds(1440, 260, 220, 22);

        jLabel206.setText("Diagnosa Sekunder 3");
        jLabel206.setName("jLabel206"); // NOI18N
        internalFrame7.add(jLabel206);
        jLabel206.setBounds(1440, 240, 140, 16);

        jTextField10.setName("jTextField10"); // NOI18N
        internalFrame7.add(jTextField10);
        jTextField10.setBounds(1440, 310, 220, 22);

        jLabel207.setText("Diagnosa Sekunder 4");
        jLabel207.setName("jLabel207"); // NOI18N
        internalFrame7.add(jLabel207);
        jLabel207.setBounds(1440, 290, 140, 16);

        internalFrame4.add(internalFrame7);
        internalFrame7.setBounds(0, 0, 494, 2500);
...
//                    });
                ...
                String jumlah = (tbProsedurePasien.getValueAt(i, 3) != null)
                ? tbProsedurePasien.getValueAt(i, 3).toString()
                : "0";
                Sequel.menyimpan("tb_idrg_prosedure", "?,?,?,?,?", "ICD 9", 5, new String[]{
                    norawat, tbProsedurePasien.getValueAt(i, 0).toString(), status, Sequel.cariIsi("select ifnull(MAX(prioritas)+1,1) from tb_idrg_prosedure where no_rawat=? and status='" + status + "'", norawat), jumlah
                });
            }
        }
        tampilProsedureIDRG();
    ...
    private void btnDeleteDiagnosaIDRGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteDiagnosaIDRGActionPerformed
        ...
        Sequel.queryu("delete from diagnosa_pasien where no_rawat='" + norawat + "' and kd_penyakit='" + tbDiagnosaIDRG.getValueAt(tbDiagnosaIDRG.getSelectedRow(), 0).toString() + "'  ");
        tampilDiagnosaIDRG();
 ...
 Sequel.queryu("delete from tb_inacbg_diagnose where no_rawat='" + norawat + "' and code='" + tbDiagnosaIINACBG.getValueAt(tbDiagnosaIINACBG.getSelectedRow(), 0).toString() + "'  ");
    ...
    private void btnHasilFinalKlaimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHasilFinalKlaimActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        getHasilKlaim();
        WindowHasilKlaim.setSize(750, 140);
        WindowHasilKlaim.setLocationRelativeTo(internalFrame1);
        WindowHasilKlaim.setVisible(true);
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_btnHasilFinalKlaimActionPerformed

    private void btnHasilFinalKlaimKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnHasilFinalKlaimKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnHasilFinalKlaimKeyPressed
    ...
    private void btnDeleteProcedureIDRGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteProcedureIDRGActionPerformed
        ...
        Sequel.queryu("delete from prosedur_pasien where no_rawat='" + norawat + "' and kode='" + tbProsedurIDRG.getValueAt(tbProsedurIDRG.getSelectedRow(), 0).toString() + "' and prioritas='" + tbProsedurIDRG.getValueAt(tbProsedurIDRG.getSelectedRow(), 4).toString() + "'  ");
        tampilProsedureIDRG();        
    ...
    private void CmbSpecialProcedureItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CmbSpecialProcedureItemStateChanged
        ...
        if (evt.getStateChange() == ItemEvent.SELECTED) {
            ...
            try {
                ...
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg_dev/index.php?act=getCmg&nikCoder=" + nikCoder;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\","
                        + "\"speciapCmg\": \"" + allCmg + "\""
...
//                            }
 ...
 Sequel.queryu("delete from tb_inacbg_prosedure where no_rawat='" + norawat + "' and kode='" + tbProsedureINACBG.getValueAt(tbProsedureINACBG.getSelectedRow(), 0).toString() + "'  ");
    ...
    private void btnDiagnosaLocalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDiagnosaLocalActionPerformed
        ...
        diagnosa.isCek();
                                        try{
                                    date = new SimpleDateFormat("yyyy-MM-dd").parse(tglMasuk.getText());
                                }catch(Exception e){
                                    date=new Date();
                                }
        diagnosa.setNoRm(txtNoRawat.getText(),date,date,jnsLayanan.getText());
        diagnosa.panelDiagnosa1.tampil();
        diagnosa.setVisible(true);
    }//GEN-LAST:event_btnDiagnosaLocalActionPerformed

    private void txtNoRawat1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNoRawat1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtNoRawat1KeyPressed

    private void txtNoRm1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNoRm1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtNoRm1KeyPressed

    private void noKartuJkn1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_noKartuJkn1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_noKartuJkn1KeyPressed

    private void jnsLayanan1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jnsLayanan1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_jnsLayanan1KeyPressed
    ...
    private void jamMasuk1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jamMasuk1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_jamMasuk1KeyPressed

    private void tglMasuk1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tglMasuk1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tglMasuk1KeyPressed

    private void tglPulang1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tglPulang1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tglPulang1KeyPressed

    private void jamPulang1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jamPulang1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_jamPulang1KeyPressed
    ...
    private void sistol1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_sistol1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_sistol1KeyPressed

    private void ChkPasienTB1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_ChkPasienTB1ItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_ChkPasienTB1ItemStateChanged

    private void txtIDSITB1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtIDSITB1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtIDSITB1KeyPressed

    private void btnValidasiSITB1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnValidasiSITB1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnValidasiSITB1ActionPerformed

    private void beratLahir1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_beratLahir1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_beratLahir1KeyPressed

    private void tarifPoliEksekutif3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tarifPoliEksekutif3KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tarifPoliEksekutif3KeyPressed

    private void tarifPoliEksekutif3KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tarifPoliEksekutif3KeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_tarifPoliEksekutif3KeyReleased

    private void chkEksekutif1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chkEksekutif1ItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_chkEksekutif1ItemStateChanged

    private void chkNaikKelas1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chkNaikKelas1ItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_chkNaikKelas1ItemStateChanged

    private void chkIntensif1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chkIntensif1ItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_chkIntensif1ItemStateChanged

    private void tarifPoliEksekutif1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tarifPoliEksekutif1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tarifPoliEksekutif1KeyPressed

    private void tarifPoliEksekutif1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tarifPoliEksekutif1KeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_tarifPoliEksekutif1KeyReleased

    private void subAcute1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_subAcute1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_subAcute1KeyPressed

    private void chronic1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_chronic1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_chronic1KeyPressed

    private void chkVentilator1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chkVentilator1ItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_chkVentilator1ItemStateChanged

    private void tglIntubasi1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tglIntubasi1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tglIntubasi1KeyPressed

    private void tglEkstubasi1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tglEkstubasi1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tglEkstubasi1KeyPressed

    private void icuLos1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_icuLos1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_icuLos1KeyPressed

    private void icuLos1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_icuLos1KeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_icuLos1KeyReleased

    private void cmbCaraMasuk1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbCaraMasuk1ItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbCaraMasuk1ItemStateChanged

    private void cmbCaraMasuk1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmbCaraMasuk1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbCaraMasuk1KeyPressed

    private void cmrCaraPulang1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmrCaraPulang1ItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_cmrCaraPulang1ItemStateChanged

    private void cmrCaraPulang1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmrCaraPulang1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmrCaraPulang1KeyPressed

    private void tfTotal1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfTotal1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfTotal1KeyPressed

    private void tfNonBedah1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfNonBedah1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfNonBedah1KeyPressed

    private void tfRehabilitasi1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfRehabilitasi1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfRehabilitasi1KeyPressed

    private void tfBedah1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfBedah1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfBedah1KeyPressed

    private void tfKonsultasi1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfKonsultasi1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfKonsultasi1KeyPressed

    private void tfKamar1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfKamar1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfKamar1KeyPressed

    private void tfRawatIntensif1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfRawatIntensif1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfRawatIntensif1KeyPressed

    private void setDataKlaim1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_setDataKlaim1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_setDataKlaim1ActionPerformed

    private void btnUpdateDataKlaim1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateDataKlaim1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnUpdateDataKlaim1ActionPerformed

    private void btnImportDiagnosaDokter1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImportDiagnosaDokter1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnImportDiagnosaDokter1ActionPerformed

    private void btnDiagnosaLocal1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDiagnosaLocal1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnDiagnosaLocal1ActionPerformed

    private void tbProsedurIDRG1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbProsedurIDRG1MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_tbProsedurIDRG1MouseClicked

    private void btnGroupingIDRG1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGroupingIDRG1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnGroupingIDRG1ActionPerformed

    private void btnTambahDiagnosaIDRG1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahDiagnosaIDRG1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnTambahDiagnosaIDRG1ActionPerformed

    private void btnTambahProsedurIDRG1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahProsedurIDRG1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnTambahProsedurIDRG1ActionPerformed

    private void btnFinalIDRG1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFinalIDRG1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnFinalIDRG1ActionPerformed

    private void btnEditIDRG1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditIDRG1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnEditIDRG1ActionPerformed

    private void btnImportToINACBG1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImportToINACBG1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnImportToINACBG1ActionPerformed

    private void btnGroupingINACBG1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGroupingINACBG1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnGroupingINACBG1ActionPerformed

    private void btnTabahDiagnosaINACBG1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTabahDiagnosaINACBG1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnTabahDiagnosaINACBG1ActionPerformed

    private void btnTambahProsedurINACBG1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahProsedurINACBG1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnTambahProsedurINACBG1ActionPerformed

    private void btnFinalINACBG1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFinalINACBG1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnFinalINACBG1ActionPerformed

    private void btnEditINACBG1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditINACBG1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnEditINACBG1ActionPerformed

    private void CmbSpecialProcedure1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CmbSpecialProcedure1ItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_CmbSpecialProcedure1ItemStateChanged

    private void CmbSpecialProcedure1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CmbSpecialProcedure1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_CmbSpecialProcedure1KeyPressed

    private void CmbSpecialProsthesis1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CmbSpecialProsthesis1ItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_CmbSpecialProsthesis1ItemStateChanged

    private void CmbSpecialProsthesis1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CmbSpecialProsthesis1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_CmbSpecialProsthesis1KeyPressed

    private void CmbSpecialInvestigation1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CmbSpecialInvestigation1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_CmbSpecialInvestigation1KeyPressed

    private void CmbSpeciaDrugs1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CmbSpeciaDrugs1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_CmbSpeciaDrugs1KeyPressed

    private void btnEditKlaim1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditKlaim1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnEditKlaim1ActionPerformed

    private void btnFinalKlaim1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFinalKlaim1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnFinalKlaim1ActionPerformed

    private void btnKirimOnline1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKirimOnline1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnKirimOnline1ActionPerformed

    private void btnCetakKlaim1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakKlaim1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnCetakKlaim1ActionPerformed

    private void btnCetakKlaim1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCetakKlaim1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnCetakKlaim1KeyPressed

    private void btnHasilFinalKlaim1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHasilFinalKlaim1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnHasilFinalKlaim1ActionPerformed

    private void btnHasilFinalKlaim1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnHasilFinalKlaim1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnHasilFinalKlaim1KeyPressed

    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgDetailKlaim3 dialog = new DlgDetailKlaim3(new javax.swing.JFrame(), true);
    ...
    private widget.PanelBiasa FormInputHasilIDRG1;
    private widget.PanelBiasa FormInputHasilINACBG;
    private widget.PanelBiasa FormInputHasilINACBG1;
    private widget.PanelBiasa FormInputIDRG;
    private widget.PanelBiasa FormInputIDRG1;
    private widget.PanelBiasa FormInputINACBG;
    private widget.PanelBiasa FormInputINACBG1;
    private widget.PanelBiasa FormInputStatusKlaim;
    private widget.PanelBiasa FormInputStatusKlaim1;
    private widget.InternalFrame FormKodingIDRG;
    private widget.InternalFrame FormKodingIDRG1;
    private widget.InternalFrame FormKodingINACBG;
    private widget.InternalFrame FormKodingINACBG1;
    private widget.InternalFrame FrameKoding;
    private widget.InternalFrame FrameKoding1;
    ...
    private widget.Label SpecialProcedureHasilCode1;
    private widget.Label SpecialProcedureHasilCost;
    private widget.Label SpecialProcedureHasilCost1;
    private widget.Label SpecialProsthesisHasilCode;
    private widget.Label SpecialProsthesisHasilCode1;
    private widget.Label SpecialProsthesisHasilCost;
    private widget.Label SpecialProsthesisHasilCost1;
    ...
    private widget.TextBox beratLahir1;
    private widget.Button btnCetakKlaim;
    private widget.Button btnCetakKlaim1;
    ...
    private widget.Button btnDiagnosaLocal;
    private widget.Button btnDiagnosaLocal1;
    private widget.Button btnEditIDRG;
    private widget.Button btnEditIDRG1;
    private widget.Button btnEditINACBG;
    private widget.Button btnEditINACBG1;
    private widget.Button btnEditKlaim;
    private widget.Button btnEditKlaim1;
    private widget.Button btnFinalIDRG;
    private widget.Button btnFinalIDRG1;
    private widget.Button btnFinalINACBG;
    private widget.Button btnFinalINACBG1;
    private widget.Button btnFinalKlaim;
    private widget.Button btnFinalKlaim1;
    private widget.Button btnGroupingIDRG;
    private widget.Button btnGroupingIDRG1;
    private widget.Button btnGroupingINACBG;
    private widget.Button btnGroupingINACBG1;
    private widget.Button btnHasilFinalKlaim;
    private widget.Button btnHasilFinalKlaim1;
    private widget.Button btnImportDiagnosaDokter;
    private widget.Button btnImportDiagnosaDokter1;
    private widget.Button btnImportToIDRG;
    private widget.Button btnImportToINACBG;
    private widget.Button btnImportToINACBG1;
    private widget.Button btnKirimOnline;
    private widget.Button btnKirimOnline1;
    private javax.swing.JMenuItem btnMultiplicity;
    private widget.Button btnTabahDiagnosaINACBG;
    private widget.Button btnTabahDiagnosaINACBG1;
    private widget.Button btnTambahDiagnosaIDRG;
    private widget.Button btnTambahDiagnosaIDRG1;
    private widget.Button btnTambahProsedurIDRG;
    private widget.Button btnTambahProsedurIDRG1;
    private widget.Button btnTambahProsedurINACBG;
    private widget.Button btnTambahProsedurINACBG1;
    private widget.Button btnUpdateDataKlaim;
    private widget.Button btnUpdateDataKlaim1;
    private widget.Button btnValidasiSITB;
    private widget.Button btnValidasiSITB1;
    private javax.swing.ButtonGroup buttonGroupNaikKelas;
    private widget.CekBox chkEksekutif;
    private widget.CekBox chkEksekutif1;
    private widget.CekBox chkIntensif;
    private widget.CekBox chkIntensif1;
    private widget.CekBox chkNaikKelas;
    private widget.CekBox chkNaikKelas1;
    private widget.CekBox chkVentilator;
    private widget.CekBox chkVentilator1;
    private widget.TextBox chronic;
    private widget.TextBox chronic1;
    private widget.Label chronicHasilINACBG;
    private widget.Label chronicHasilINACBG1;
    private widget.ComboBox cmbCaraMasuk;
    private widget.ComboBox cmbCaraMasuk1;
    private widget.ComboBox cmrCaraPulang;
    private widget.ComboBox cmrCaraPulang1;
    private widget.Label costPoliEksekutif;
    private widget.Label costPoliEksekutif1;
    private widget.TextBox diastol;
    private widget.TextBox diastol1;
    private widget.Label drgCodeHasiliDRG;
    private widget.Label drgCodeHasiliDRG1;
    private widget.Label drgHasiliDRG;
    private widget.Label drgHasiliDRG1;
    ...
    private widget.Label groupCodeHasilINACBG3;
    private widget.Label groupCodeHasilINACBG4;
    private widget.Label groupCodeHasilINACBG5;
    private widget.Label groupCodeHasilINACBG6;
    private widget.Label groupCodeHasilINACBG7;
    private widget.Label groupCodeHasilINACBG8;
    private widget.Label groupCodeHasilINACBG9;
    ...
    private widget.Label groupCostHasilINACBG3;
    private widget.Label groupCostHasilINACBG4;
    private widget.Label groupCostHasilINACBG5;
    private widget.Label groupCostHasilINACBG6;
    private widget.Label groupCostHasilINACBG7;
    private widget.Label groupCostHasilINACBG8;
    private widget.Label groupCostHasilINACBG9;
    private widget.Label groupHasilINACBG;
    private widget.Label groupHasilINACBG1;
    private widget.TextBox icuLos;
    private widget.TextBox icuLos1;
    private widget.Label infoHasilINACBG;
    private widget.Label infoHasilINACBG1;
    private widget.Label infoHasiliDRG;
    private widget.Label infoHasiliDRG1;
    ...
    private widget.InternalFrame internalFrame41;
    private widget.InternalFrame internalFrame42;
    private widget.InternalFrame internalFrame43;
    private widget.InternalFrame internalFrame44;
    private widget.InternalFrame internalFrame45;
    private widget.InternalFrame internalFrame46;
    private widget.InternalFrame internalFrame47;
    private widget.InternalFrame internalFrame48;
    private widget.InternalFrame internalFrame49;
    private widget.InternalFrame internalFrame5;
    private widget.InternalFrame internalFrame50;
    private widget.InternalFrame internalFrame51;
    private widget.InternalFrame internalFrame52;
    private widget.InternalFrame internalFrame53;
    private widget.InternalFrame internalFrame54;
    private widget.InternalFrame internalFrame55;
    private widget.InternalFrame internalFrame56;
    private widget.InternalFrame internalFrame57;
    private widget.InternalFrame internalFrame58;
    private widget.InternalFrame internalFrame59;
    private widget.InternalFrame internalFrame6;
    private widget.InternalFrame internalFrame60;
    private widget.InternalFrame internalFrame61;
    private widget.InternalFrame internalFrame62;
    private widget.InternalFrame internalFrame63;
    private widget.InternalFrame internalFrame7;
    private widget.InternalFrame internalFrame8;
    private widget.InternalFrame internalFrame9;
    private widget.InternalFrame internalFrameD1ataPasien;
    private widget.InternalFrame internalFrameD1ataPasien1;
    private widget.InternalFrame internalFrameDataPasien;
    private widget.InternalFrame internalFrameDataPasien1;
    ...
    private widget.InternalFrame internalFrameEndKlaim1;
    ...
    private widget.TextBox jamMasuk1;
    private widget.TextBox jamPulang;
    private widget.TextBox jamPulang1;
    private widget.TextBox jnsLayanan;
    private widget.TextBox jnsLayanan1;
    private widget.Label jnsrawatHasilINACBG;
    private widget.Label jnsrawatHasilINACBG1;
    private widget.Label jsnrawatHasiliDRG;
    private widget.Label jsnrawatHasiliDRG1;
    ...
    private widget.PanelBiasa panelCeklis1;
    private widget.PanelBiasa panelHasilIDRG;
    private widget.PanelBiasa panelHasilIDRG1;
    private widget.PanelBiasa panelHasilINACBG;
    private widget.PanelBiasa panelHasilINACBG1;
    private widget.PanelBiasa panelHasilINACBG2;
    private widget.PanelBiasa panelHasilINACBG3;
    private widget.PanelBiasa panelNaikKelas;
    private widget.PanelBiasa panelNaikKelas1;
    private widget.PanelBiasa panelRawatIntensif;
    private widget.PanelBiasa panelRawatIntensif1;
    private widget.PanelBiasa panelTarifPoliEksekutif;
    private widget.PanelBiasa panelTarifPoliEksekutif1;
    ...
    private widget.TextBox tglPulang1;
    private widget.Label totalCostHasilKlaim;
    private widget.Label totalCostHasilKlaim1;
    ...
    private widget.TextBox txtHakKelas1;
    private widget.TextBox txtIDSITB;
    private widget.TextBox txtIDSITB1;
    ...
    private widget.TextBox txtNamaPasien1;
    private widget.TextBox txtNoRawat;
    private widget.TextBox txtNoRawat1;
    private widget.TextBox txtNoRm;
    private widget.TextBox txtNoRm1;
    private widget.TextBox txtNoSep;
    private widget.TextBox txtNoSep1;
...
//        caraPulang=Sequel.cariIsi("select nm_dokter from reg_periksa JOIN dokter ON reg_periksa.kd_dokter=dokter.kd_dokter where no_rawat='" + noRawat + "'");
        ...
        String[] parts = (tglAkhir == null) ? new String[0] : tglAkhir.split(" ", 2);
        jamPulang.setText(parts.length > 1 ? parts[1] : "");
...
//        nmDokter.setText(dokter);
        ...
        tampilProsedureINACBG();
                        ...
                        //tambahan
                        // DEBUG: cek user login dan nik coder
//                System.out.println("DEBUG Login ID (akses.getkode()): " + akses.getkode());

                nikCoder = Sequel.cariIsi(
                    "SELECT no_ik FROM inacbg_coder_nik WHERE nik=?",
                    akses.getkode()
                );

//                System.out.println("DEBUG Hasil Query nikCoder: " + nikCoder);
...
//                String nikCoder = Sequel.cariIsi(
//                "SELECT no_ik FROM inacbg_coder_nik WHERE nik=?",
//                akses.getkode()
//                );
                ...
                requestEntity = new HttpEntity(headers);
                //tambahan
//                System.out.println("DEBUG Kirim Klaim - nikCoder yang digunakan: " + nikCoder);
//                System.out.println("DEBUG URL: " + "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" 
//                + koneksiDB.HYBRIDWEB() 
//                + "/inacbg_idrg_dev/index.php?act=createClaim&nikCoder=" + nikCoder);
           
                
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg_dev/index.php?act=createClaim&nikCoder=" + nikCoder;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\","
                        + "\"no_jkn\": \"" + noKartu + "\","
    ...
    private void updateDataClaim() {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg_dev/index.php?act=updateClaim&nikCoder=" + nikCoder;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\","
                        + "\"no_jkn\": \"" + noKartu + "\","
    ...
    private void validasiPasienTB(String idTB) {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg_dev/index.php?act=validateSITB&nikCoder=" + nikCoder;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\","
                        + "\"no_reg_sitb\": \"" + idTB + "\""
...
//                headers.setContentType(MediaType.APPLICATION_JSON);
//                requestEntity = new HttpEntity(headers);
//                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg_dev/index.php?act=setDiagnosaIDRG&nikCoder=" + nikCoder;
//                requestEntity = new HttpEntity(headers);
//                requestJson = "{"
//                        + "\"no_sep\": \"" + noSep + "\","
//                        + "\"diagnosa\": \"" + diagPasien + "\","
...
//    }
    ...
    try {
        // 1️⃣ Ambil daftar diagnosa
        for (int i = 0; i < tbDiagnosaIDRG.getRowCount(); i++) {
            listDiagnosa += tbDiagnosaIDRG.getValueAt(i, 0).toString() + "#";
        }
        String diagPasien = (listDiagnosa.length() > 0) ? listDiagnosa.substring(0, listDiagnosa.length() - 1) : "";

        // 2️⃣ Ambil daftar prosedur dengan volume (multiply)
        for (int i = 0; i < tbProsedurIDRG.getRowCount(); i++) {
            String kode = tbProsedurIDRG.getValueAt(i, 0).toString();
            String vol = "1";
            try {
                vol = tbProsedurIDRG.getValueAt(i, 3).toString();
            } catch (Exception e) {
                vol = "1";
            }

            if (vol.equals("1")) {
                listProsedur += kode + "#";  // volume 1 tidak perlu ditulis
            } else {
                listProsedur += kode + "+" + vol + "#"; // volume >1 ditulis sebagai kode+volume
            }
        }
        String procedurePasien = (listProsedur.length() > 0) ? listProsedur.substring(0, listProsedur.length() - 1) : "";

        // 3️⃣ Buat JSON request
        JSONObject jsonRequest = new JSONObject();
        jsonRequest.put("no_sep", noSep);
        jsonRequest.put("diagnosa", diagPasien);
        jsonRequest.put("prosedure", procedurePasien); // tetap string
        ...
        headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
        requestEntity = new HttpEntity(jsonRequest.toString(), headers);
        URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB()
                + "/inacbg_idrg_dev/index.php?act=setDiagnosaIDRG&nikCoder=" + nikCoder;

        root = mapper.readTree(api.getRest().exchange(URL, HttpMethod.POST, requestEntity, String.class).getBody());
        System.out.println("JSON Response: " + root);

        // 5️⃣ Parsing response
        if (root.path("metadata").path("code").asText().equals("200")) {
            JsonNode response = root.path("response_idrg");
            String jnsRawat = status.equals("Ralan") ? "Rawat Jalan" : status.equals("Ranap") ? "Rawat Inap" : "Rawat Jalan";

            // Update status eklaim
            if (response.path("mdc_number").asText().equals("36")) {
                Sequel.mengedit("tt_status_eklaim", "no_rawat=? and no_sep=?", "grouping_idrg=?,grouping_idrg_status=?", 4,
                        new String[]{"true", "false", norawat, noSep});
            } else {
                Sequel.mengedit("tt_status_eklaim", "no_rawat=? and no_sep=?", "grouping_idrg=?,grouping_idrg_status=?", 4,
                        new String[]{"true", "true", norawat, noSep});
            }

            // Simpan / update hasil grouping
            if (Sequel.cariInteger("select count(no_rawat) from tb_idrg_grouping_result where no_rawat='" + norawat + "' and no_sep='" + noSep + "'") > 0) {
                Sequel.mengedit("tb_idrg_grouping_result", "no_rawat=? and no_sep=?", "mdc_number=?,mdc_description=?,drg_code=?,drg_description=?,script_version=?,logic_version=?,datetime=?", 9,
                        new String[]{
                                response.path("mdc_number").asText(),
                                response.path("mdc_description").asText(),
                                response.path("drg_code").asText(),
                                response.path("drg_description").asText(),
                                response.path("script_version").asText(),
                                response.path("logic_version").asText(),
                                dateSave.format(new Date()), norawat, noSep
                        });
            } else {
                Sequel.menyimpantf2("tb_idrg_grouping_result", "?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 11,
                        new String[]{norawat, noSep, response.path("mdc_number").asText(), response.path("mdc_description").asText(),
                                response.path("drg_code").asText(), response.path("drg_description").asText(), jnsRawat, "Normal",
    ...
    private void finalDRG() {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg_dev/index.php?act=finalIDRG&nikCoder=" + nikCoder;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\""
                        + "}";
    ...
    private void editDRG() {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg_dev/index.php?act=editIDRG&nikCoder=" + nikCoder;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\""
                        + "}";
...
//                headers.setContentType(MediaType.APPLICATION_JSON);
//                requestEntity = new HttpEntity(headers);
//                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg_dev/index.php?act=importCoding&nikCoder=" + nikCoder;
//                requestEntity = new HttpEntity(headers);
//                requestJson = "{"
//                        + "\"no_sep\": \"" + noSep + "\""
//                        + "}";
...
//    }
    ...
    try {
        // 1️⃣ Siapkan header dan JSON request
        headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
        JSONObject jsonRequest = new JSONObject();
        jsonRequest.put("no_sep", noSep);
        ...
        // 2️⃣ Tentukan URL endpoint
        URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB()
                + "/inacbg_idrg_dev/index.php?act=importCoding&nikCoder=" + nikCoder;

        System.out.println("JSON Request: " + jsonRequest.toString());

        // 3️⃣ Kirim POST request ke server
        root = mapper.readTree(api.getRest().exchange(URL, HttpMethod.POST, requestEntity, String.class).getBody());
        System.out.println("JSON Response: " + root);
        ...
        if (root.path("metadata").path("code").asText().equals("200")) {
            ...
            // 6️⃣ Import Prosedur (dengan multiply)
            if (responseProcedure.path("expanded").isArray()) {
                int i = 1;
                for (JsonNode listProcedure : responseProcedure.path("expanded")) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Gagal import coding. Cek server atau data.");
        }
...
//                    }
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg_dev/index.php?act=setDiagnosaINACBG&nikCoder=" + nikCoder;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\","
                        + "\"diagnosa\": \"" + diagPasien + "\","
...
//                    }
                    ...
                    cekStatusKlaim();
                            ...
                            if (Sequel.cariInteger("SELECT count(no_rawat) FROM tb_inacbg_grouping_result WHERE no_rawat='" + norawat + "' AND (cbg_description LIKE '%ERROR%' OR cbg_description LIKE '%GAGAL%')") > 0) {
                                // KONDISI 1: ADA ERROR/GAGAL
                                btnFinalINACBG.setVisible(false);
                                groupHasilINACBG.setForeground(Color.RED); // Atur menjadi MERAH
                                totalCostHasilKlaim.setText("");
                            } else {
                                // KONDISI 2: TIDAK ADA ERROR/GAGAL
                                btnFinalINACBG.setVisible(true); // Pastikan tombol terlihat (atau setEnabled(true) jika sebelumnya disable)
...
//            CatatanVerifikasi.dispose();
    ...
    private void getDataKlaim() {
        try {
            ...
            headers.setContentType(MediaType.APPLICATION_JSON);
            requestEntity = new HttpEntity(headers);
            URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg_dev/index.php?act=getKlaim&nikCoder=" + nikCoder;
            requestEntity = new HttpEntity(headers);
            requestJson = "{"
                    + "\"no_sep\": \"" + noSep + "\""
                    + "}";
    ...
    private void finalINACBG() {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg_dev/index.php?act=finalINACBG&nikCoder=" + nikCoder;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\""
                        + "}";
    ...
    private void editINACBG() {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg_dev/index.php?act=editINACBG&nikCoder=" + nikCoder;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\""
                        + "}";
    ...
    private void finalKlaim() {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg_dev/index.php?act=finalKlaim&nikCoder=" + nikCoder;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\""
                        + "}";
    ...
    private void editKlaim() {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg_dev/index.php?act=editKlaim&nikCoder=" + nikCoder;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\""
                        + "}";
...
//                            }
    ...
    private void cetakKlaim() {
            ...
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg_dev/index.php?act=cetakKlaim&nikCoder=" + nikCoder;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\""
                        + "}";
     ...
     private void KirimOnlineKlaim() {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            try {
                ...
                headers.setContentType(MediaType.APPLICATION_JSON);
                requestEntity = new HttpEntity(headers);
                URL = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/inacbg_idrg_dev/index.php?act=kirimOnlineKlaim&nikCoder=" + nikCoder;
                requestEntity = new HttpEntity(headers);
                requestJson = "{"
                        + "\"no_sep\": \"" + noSep + "\""
                        + "}";
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (rs.getString("kirim_online").equals("true")) {
                        formTarifVisible(false);
                        btnDiagnosaLocal.setVisible(false);
                        btnImportDiagnosaDokter.setVisible(false);
                        btnDeleteProcedureIDRG.setEnabled(false);//disable delete
                        btnMultiplicity.setEnabled(false);//disable
                        btnDeleteDiagnosaIDRG.setEnabled(false);//disable
                        btnUpdateDataKlaim.setVisible(false);
                        ...
                        btnDeleteProcedureINACBG.setEnabled(false);//disable
                        btnDeleteDiagnosaINACBG.setEnabled(false);//disable
                        ...
                        btnHasilFinalKlaim.setVisible(true);
                    ...
                    } else if (rs.getString("final_klaim").equals("true")) {
                        formTarifVisible(false);
                        btnDiagnosaLocal.setVisible(false);
                        btnImportDiagnosaDokter.setVisible(false);
                        btnDeleteProcedureIDRG.setEnabled(false);//disable delete
                        ...
                        btnCetakKlaim.setVisible(true);
                        btnHasilFinalKlaim.setVisible(false);
                        FormInputStatusKlaim.setVisible(true);
                        getHasilKlaim();
                        getHasilINACBG();
                        FormInputHasilINACBG.setVisible(true);
                        ...
                        panelHasilIDRG.setWarnaAtas(new Color(153, 255, 153));
                        panelHasilIDRG.setWarnaBawah(new Color(153, 255, 153));
                    } else if (rs.getString("final_inacbg").equals("true")) {
                        formTarifVisible(false);
                        btnDiagnosaLocal.setVisible(false);
                        btnImportDiagnosaDokter.setVisible(false);
                        btnDeleteProcedureIDRG.setEnabled(false);//disable delete
                        ...
                        panelHasilIDRG.setWarnaAtas(new Color(153, 255, 153));
                        panelHasilIDRG.setWarnaBawah(new Color(153, 255, 153));
                    } else if (rs.getString("grouping_inacbg").equals("true")) {
                        formTarifVisible(false);
                        btnUpdateDataKlaim.setVisible(false);
                        FormInputIDRG.setVisible(true);
                        btnImportToIDRG.setVisible(false);
                        ...
                        btnTambahProsedurINACBG.setVisible(true);
                        btnDeleteProcedureINACBG.setEnabled(true);//disable
                        btnDeleteDiagnosaINACBG.setEnabled(true);//disable
                        btnEditINACBG.setVisible(false);
                        ...
                        panelHasilIDRG.setWarnaAtas(new Color(153, 255, 153));
                        panelHasilIDRG.setWarnaBawah(new Color(153, 255, 153));
                    } else if (rs.getString("final_idrg").equals("true")) {
                        formTarifVisible(false);
                        btnDiagnosaLocal.setVisible(false);
                        btnImportDiagnosaDokter.setVisible(false);
                        btnDeleteProcedureIDRG.setEnabled(false);//disable delete
                    ...
                    } else if (rs.getString("grouping_idrg").equals("true")) {
                        formTarifVisible(true);
                        btnDiagnosaLocal.setVisible(true);
                        btnImportDiagnosaDokter.setVisible(true);
                        btnDeleteProcedureIDRG.setEnabled(true);//disable delete
                        btnMultiplicity.setEnabled(true);//disable
                        btnDeleteDiagnosaIDRG.setEnabled(true);//disable
                        ...
                        btnTambahDiagnosaIDRG.setVisible(false);//takdisable
                        btnTambahProsedurIDRG.setVisible(false);//takdisable
                        btnEditIDRG.setVisible(false);
                        btnImportToINACBG.setVisible(false);
                        ...
                        panelHasilIDRG.setWarnaBawah(new Color(204, 204, 204));
                         FormInputHasilINACBG.setVisible(false);
                    } else if (rs.getString("set_data_klaim").equals("true")) {
                        formTarifVisible(true);
                        btnDiagnosaLocal.setVisible(true);
                        btnImportDiagnosaDokter.setVisible(true);
                        btnDeleteProcedureIDRG.setEnabled(true);//disable delete
...
//                    if (rs.getString("set_data_klaim").equals("true")) {
//                        setDataKlaim.setVisible(false);
//                        btnUpdateDataKlaim.setVisible(true);
//                    } else {
//                        setDataKlaim.setVisible(true);
//                        btnUpdateDataKlaim.setVisible(false);
//                    }
//                    if (rs.getString("grouping_idrg").equals("true")) {
//                        btnFinalIDRG.setVisible(true);
//                        btnGroupingIDRG.setVisible(true);
//                    } else {
//                        btnFinalIDRG.setVisible(false);
//                    }
//                    if (rs.getString("final_idrg").equals("true")) {
//                        btnEditIDRG.setVisible(true);
//                        btnHasilIDRG.setVisible(true);
//                        btnFinalIDRG.setVisible(false);
//                        btnGroupingIDRG.setVisible(false);
//                        btnImportToINACBG.setVisible(true);
//
//                    } else {
//                        btnEditIDRG.setVisible(false);
//                        btnHasilIDRG.setVisible(false);
//                        btnImportToINACBG.setVisible(false);
//                    }
//                    if (rs.getString("grouping_inacbg").equals("true")) {
//                        btnFinalINACBG.setVisible(true);
//                        btnGroupingINACBG.setVisible(true);
//
//                    } else {
...
//                        btnGroupingINACBG.setVisible(false);
//                    }
//                    if (rs.getString("final_inacbg").equals("true")) {
//                        btnEditINACBG.setVisible(true);
//                        btnFinalINACBG.setVisible(true);
//                        btnGroupingINACBG.setVisible(false);
//
...
//        tfSewaAlat.setText("0");
        ...
        try {
        if (Sequel.cariInteger("SELECT COUNT(no_rawat) FROM billing WHERE no_rawat='" + norawat + "'") > 0) {
//            non_bedah   = Sequel.cariIsi("SELECT IFNULL(SUM(totalbiaya), 0) FROM billing WHERE no_rawat='" + norawat + "' AND status='Ranap Dokter Paramedis'");
            non_bedah = Sequel.cariIsi("SELECT IFNULL(SUM(totalbiaya), 0) FROM billing WHERE no_rawat='" + norawat + "' AND status='Ranap Dokter Paramedis' AND nm_perawatan NOT LIKE '%Visite%' AND nm_perawatan NOT LIKE '%Konsultasi%' AND nm_perawatan NOT LIKE '%Konsul%'");
            bedah       = Sequel.cariIsi("SELECT IFNULL(SUM(totalbiaya), 0) FROM billing WHERE no_rawat='" + norawat + "' AND status='Operasi'");
            keperawatan = Sequel.cariIsi("SELECT IFNULL(SUM(totalbiaya), 0) FROM billing WHERE no_rawat='" + norawat + "' AND status='Ranap Paramedis'");
            konsultasi  = Sequel.cariIsi("SELECT IFNULL(SUM(totalbiaya), 0) FROM billing WHERE no_rawat='" + norawat + "' AND (nm_perawatan LIKE '%Konsul%' OR nm_perawatan LIKE '%Visite%')");
            radiologi   = Sequel.cariIsi("SELECT IFNULL(SUM(totalbiaya), 0) FROM billing WHERE no_rawat='" + norawat + "' AND status='Radiologi'");
            lab         = Sequel.cariIsi("SELECT IFNULL(SUM(totalbiaya), 0) FROM billing WHERE no_rawat='" + norawat + "' AND status='Laborat'");
            obat        = Sequel.cariIsi("SELECT IFNULL(SUM(totalbiaya), 0) FROM billing WHERE no_rawat='" + norawat + "' AND status IN ('Obat', 'Resep Pulang')");
            kamar        = Sequel.cariIsi("SELECT IFNULL(SUM(totalbiaya), 0) FROM billing WHERE no_rawat='" + norawat + "' AND status IN ('Kamar', 'Registrasi')");
        } else {
            non_bedah = bedah = keperawatan = konsultasi = radiologi = lab = obat = kamar = "0";
        }

        // ✅ Gunakan Double.parseDouble agar aman dari "0.0", "123.45", atau ""
        double totalNonBedah   = parseDoubleSafe(non_bedah);
        double totalBedah      = parseDoubleSafe(bedah);
        double totalKeperawatan= parseDoubleSafe(keperawatan);
        double totalKonsultasi = parseDoubleSafe(konsultasi);
        double totalRadiologi  = parseDoubleSafe(radiologi);
        double totalLab        = parseDoubleSafe(lab);
        double totalObat       = parseDoubleSafe(obat);
        double totalKamar        = parseDoubleSafe(kamar); // Gabungan Kamar + Administrasi

        double subTotal = totalNonBedah + totalBedah + totalKeperawatan + totalKonsultasi + totalRadiologi + totalLab + totalObat + totalKamar;

        // ✅ Tampilkan hasil ke text field (tanpa notasi ilmiah)
        tfTotal.setText(String.format("%.0f", subTotal));
        tfNonBedah.setText(String.format("%.0f", totalNonBedah));
        tfBedah.setText(String.format("%.0f", totalBedah));
        tfKeperawatan.setText(String.format("%.0f", totalKeperawatan));
        tfKonsultasi.setText(String.format("%.0f", totalKonsultasi));
        tfRadiologi.setText(String.format("%.0f", totalRadiologi));
        tfLaboratorium.setText(String.format("%.0f", totalLab));
        tfObat.setText(String.format("%.0f", totalObat));
        tfKamar.setText(String.format("%.0f", totalKamar)); // Gabungan dua kategori

        // ✅ Set field lain default 0
        tfTenagaAhli.setText("0");
        tfRehabilitasi.setText("0");
        tfAlkes.setText("0");
//        tfKamar.setText("0");
        ...
        System.out.println("Error getDataBilling: " + e);
        JOptionPane.showMessageDialog(null, "Terjadi kesalahan saat mengambil data billing!");
    }
...
//        try {
//            ps=koneksi.prepareStatement(
////                    "SELECT persetujuan_penolakan_tindakan.penerima_informasi,persetujuan_penolakan_tindakan.alasan_diwakilkan_penerima_informasi,persetujuan_penolakan_tindakan.alamat_penerima_informasi,persetujuan_penolakan_tindakan.no_hp, "+
////                    "persetujuan_penolakan_tindakan.umur_penerima_informasi,persetujuan_penolakan_tindakan.saksi_keluarga,"+
////                    "persetujuan_penolakan_tindakan.tanggal_lahir_penerima_informasi, if(persetujuan_penolakan_tindakan.jk_penerima_informasi='L','LAKI-LAKI','PEREMPUAN') as jk FROM persetujuan_penolakan_tindakan"+
////                    "where persetujuan_penolakan_tindakan.no_rawat=?");
...
////                    TglLahirPenerima.setDate(rs.getDate("tanggal_lahir_penerima_informasi"));
////                    JKPenerima.setSelectedItem(rs.getString("jk"));
////                    HubunganDenganPasien.setSelectedItem(rs.getString("hubungan_penerima_informasi"));
//
//                    
//                    
//                }
