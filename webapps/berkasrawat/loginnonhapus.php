<?php
    ...
    if ($_GET['act']=="login"){
        if((USERHYBRIDWEB==$usere)&&(PASHYBRIDWEB==$passwordte)){
            ...
            if ($keyword != NULL) {
                $url = "index.php?act=ListNonHapus&iyem=".encrypt_decrypt("{\"tahunawal\":\"".$tahun."\",\"bulanawal\":\"".$bulan."\",\"tanggalawal\":\"".$tanggal."\",\"tahunakhir\":\"".$tahun."\",\"bulanakhir\":\"".$bulan."\",\"tanggalakhir\":\"".$tanggal."\",\"keyword\":\"".$keyword."\"}","e");
            } else {
